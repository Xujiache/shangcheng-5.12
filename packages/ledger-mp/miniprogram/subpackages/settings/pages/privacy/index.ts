...
const DEFS: ToggleItem[] = [
  {
    ...
    iconSrc: '/subpackages/settings/assets/privacy-hidden.png',
    label: '隐藏金额',
    sub: '列表中以星号隐藏敏感金额',
    on: false,
  },
  {
    key: 'bio',
    settingKey: 'bioLock',
    iconSrc: '/subpackages/settings/assets/privacy-biometric.png',
    label: '生物解锁',
    sub: '打开应用时需指纹 / 面容验证',
    on: false,
  },
...
MotionPage({
  data: {
    ...
    links: [
      ...
      {
        iconSrc: '/subpackages/settings/assets/settings-delete.png',
        label: '注销账户',
        sub: '永久删除账号与全部数据',
