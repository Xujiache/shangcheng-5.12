...
function make_xlsx_lib(e) {
  ...
  var h = function (e) {
    var r = e.charCodeAt(0),
      t = e.charCodeAt(1)
    if (r == 255 && t == 254) return f(e.slice(2))
  ...
  function b(e) {
    ...
    for (var c = 0; c < e.length; ) {
      ...
      r += g.charAt(i) + g.charAt(s) + g.charAt(l) + g.charAt(o)
    }
    return r
  }
  function w(e) {
  ...
  function x(e) {
    if (y) return Buffer.alloc ? Buffer.alloc(e) : new Buffer(e)
    return typeof Uint8Array != 'undefined' ? new Uint8Array(e) : new Array(e)
  }
  function S(e) {
    if (y) return Buffer.allocUnsafe ? Buffer.allocUnsafe(e) : new Buffer(e)
    return typeof Uint8Array != 'undefined' ? new Uint8Array(e) : new Array(e)
  }
  var C = function Cc(e) {
    if (y) return k(e, 'binary')
  ...
  function E(e) {
    ...
    if (e instanceof ArrayBuffer) return E(new Uint8Array(e))
  ...
  var F = y
    ? function (e) {
        return Buffer.concat(
          e.map(function (e) {
            return Buffer.isBuffer(e) ? e : k(e)
          }),
        )
      }
    : function (e) {
  ...
  function P(e, r) {
    var t = '' + e
    return t.length >= r ? t : br('0', r - t.length) + t
  }
  function I(e, r) {
    var t = '' + e
    return t.length >= r ? t : br(' ', r - t.length) + t
  }
  function R(e, r) {
    var t = '' + e
    return t.length >= r ? t : t + br(' ', r - t.length)
  }
  function L(e, r) {
    var t = '' + Math.round(e)
    return t.length >= r ? t : br('0', r - t.length) + t
  ...
  function K(e, r, t) {
    ...
    var a = e | 0,
      ...
      i = 0
    var s = []
    var l = { D: a, T: n, u: 86400 * (e - a) - n, y: 0, m: 0, d: 0, H: 0, M: 0, S: 0, q: 0 }
  ...
  function ee(e, r) {
    ...
    else if (e >= Q) t += 24 * 60 * 60 * 1e3
    return (t - (Z + (e.getTimezoneOffset() - q.getTimezoneOffset()) * 6e4)) / (24 * 60 * 60 * 1e3)
  }
  function re(e) {
  ...
  function ie(e) {
    ...
    else if (Math.abs(r) <= 9) t = ae(e)
    else if (r === 10) t = e.toFixed(10).substr(0, 12)
    else t = ne(e)
    return re(te(t.toUpperCase()))
  }
  function se(e, r) {
    switch (typeof e) {
      case 'string':
      ...
      case 'boolean':
        return e ? 'TRUE' : 'FALSE'
      case 'number':
        return (e | 0) === e ? e.toString(10) : ie(e)
      case 'undefined':
        return ''
      case 'object':
        if (e == null) return ''
        if (e instanceof Date) return Be(14, ee(e, r && r.date1904), r)
    }
  ...
  function ue(e, r, t) {
    var a = r.replace(fe, ''),
      n = r.length - a.length
    return De(e, a, t * Math.pow(10, 2 * n)) + br('%', n)
  }
  function he(e, r, t) {
    var a = r.length - 1
    while (r.charCodeAt(a - 1) === 44) --a
    return De(e, r.substr(0, a), t / Math.pow(10, 3 * (r.length - a)))
  }
  function pe(e, r) {
    var t
  ...
  function me(e, r, t) {
    ...
    return (
      ...
      ' ' +
      (s === 0
        ? br(' ', e[1].length + 1 + e[4].length)
        : I(s, e[1].length) + e[2] + '/' + e[3] + P(l, e[4].length))
    )
  }
  function ve(e, r, t) {
    return t + (r === 0 ? '' : '' + r) + br(' ', e[1].length + 2 + e[4].length)
  }
  var ge = /^#*0*\.([0#]+)/
  var be = /\).*[0#]/
  var we = /\(###\) ###\\?-####/
  ...
  function _e(e, r, t) {
    if (e.charCodeAt(0) === 40 && !r.match(be)) {
      var a = r.replace(/\( */, '').replace(/ \)/, '').replace(/\)/, '')
      if (t >= 0) return _e('n', a, t)
      return '(' + _e('n', a, -t) + ')'
    }
    if (r.charCodeAt(r.length - 1) === 44) return he(e, r, t)
    if (r.indexOf('%') !== -1) return ue(e, r, t)
    if (r.indexOf('E') !== -1) return pe(r, t)
    if (r.charCodeAt(0) === 36) return '$' + _e(e, r.substr(r.charAt(1) == ' ' ? 2 : 1), t)
    var n
    var i,
      s,
      l,
      o = Math.abs(t),
      c = t < 0 ? '-' : ''
    if (r.match(/^00+$/)) return c + U(o, r.length)
    if (r.match(/^[#?]+$/)) {
      n = U(t, 0)
      if (n === '0') n = ''
      return n.length > r.length ? n : ye(r.substr(0, r.length - n.length)) + n
    }
    if ((i = r.match(de))) return me(i, o, c)
    if (r.match(/^#+0+$/)) return c + U(o, r.length - r.indexOf('0'))
    if ((i = r.match(ge))) {
      n = ke(t, i[1].length)
        .replace(/^([^\.]+)$/, '$1.' + ye(i[1]))
        .replace(/\.$/, '.' + ye(i[1]))
        .replace(/\.(\d*)$/, function (e, r) {
          return '.' + r + br('0', ye(i[1]).length - r.length)
        })
    ...
    if ((i = r.match(/^#{1,3},##0(\.?)$/))) return c + ce(U(o, 0))
    if ((i = r.match(/^#,##0\.([#0]*0)$/))) {
      return t < 0
        ? '-' + _e(e, r, -t)
        : ce('' + (Math.floor(t) + Se(t, i[1].length))) + '.' + P(xe(t, i[1].length), i[1].length)
    }
    if ((i = r.match(/^#,#*,#0/))) return _e(e, r.replace(/^#,#*,/, ''), t)
    if ((i = r.match(/^([0#]+)(\\?-([0#]+))+$/))) {
      n = N(_e(e, r.replace(/[\\-]/g, ''), t))
      s = 0
      return N(
        N(r.replace(/\\/g, '')).replace(/[0#]/g, function (e) {
    ...
    if ((i = r.match(/^([#0?]+)( ?)\/( ?)([#0?]+)/))) {
      ...
      l = J(o, Math.pow(10, s) - 1, false)
      n = '' + c
      f = De('n', i[1], l[1])
      if (f.charAt(f.length - 1) == ' ') f = f.substr(0, f.length - 1) + '0'
      n += f + i[2] + '/' + i[3]
      f = R(l[2], s)
      if (f.length < i[4].length) f = ye(i[4].substr(i[4].length - f.length)) + f
      n += f
      return n
    }
    if ((i = r.match(/^# ([#0?]+)( ?)\/( ?)([#0?]+)/))) {
      s = Math.min(Math.max(i[1].length, i[4].length), 7)
      l = J(o, Math.pow(10, s) - 1, true)
      return (
        c +
        (l[0] || (l[1] ? '' : '0')) +
        ' ' +
        (l[1]
          ? I(l[1], s) + i[2] + '/' + i[3] + R(l[2], s)
          : br(' ', 2 * s + 1 + i[2].length + i[3].length))
      )
    }
    if ((i = r.match(/^[#0?]+$/))) {
      n = U(t, 0)
      if (r.length <= n.length) return n
      return ye(r.substr(0, r.length - n.length)) + n
    }
    if ((i = r.match(/^([#0?]+)\.([#0]+)$/))) {
      ...
      return ye(r.substr(0, u) + n + r.substr(r.length - h))
    }
  ...
  function Fe(e, r, t) {
    if (e.charCodeAt(0) === 40 && !r.match(be)) {
      var a = r.replace(/\( */, '').replace(/ \)/, '').replace(/\)/, '')
      if (t >= 0) return Fe('n', a, t)
      return '(' + Fe('n', a, -t) + ')'
    }
    if (r.charCodeAt(r.length - 1) === 44) return Ae(e, r, t)
    if (r.indexOf('%') !== -1) return Te(e, r, t)
    if (r.indexOf('E') !== -1) return Ee(r, t)
    if (r.charCodeAt(0) === 36) return '$' + Fe(e, r.substr(r.charAt(1) == ' ' ? 2 : 1), t)
    var n
    var i,
      s,
      l,
    ...
    if ((i = r.match(de))) return ve(i, o, c)
    if (r.match(/^#+0+$/)) return c + P(o, r.length - r.indexOf('0'))
    if ((i = r.match(ge))) {
      n = ('' + t).replace(/^([^\.]+)$/, '$1.' + ye(i[1])).replace(/\.$/, '.' + ye(i[1]))
    ...
    if ((i = r.match(/^#{1,3},##0(\.?)$/))) return c + ce('' + o)
    if ((i = r.match(/^#,##0\.([#0]*0)$/))) {
      return t < 0 ? '-' + Fe(e, r, -t) : ce('' + t) + '.' + br('0', i[1].length)
    }
    if ((i = r.match(/^#,#*,#0/))) return Fe(e, r.replace(/^#,#*,/, ''), t)
    if ((i = r.match(/^([0#]+)(\\?-([0#]+))+$/))) {
      n = N(Fe(e, r.replace(/[\\-]/g, ''), t))
      s = 0
      return N(
        N(r.replace(/\\/g, '')).replace(/[0#]/g, function (e) {
          return s < n.length ? n.charAt(s++) : e === '0' ? '0' : ''
    ...
    switch (r) {
      ...
      default:
        if (r.match(/\.[0#?]*$/))
          return Fe(e, r.slice(0, r.lastIndexOf('.')), t) + ye(r.slice(r.lastIndexOf('.')))
    }
    throw new Error('unsupported format |' + r + '|')
  }
  function De(e, r, t) {
    return (t | 0) === t ? Fe(e, r, t) : _e(e, r, t)
  }
  function Oe(e) {
    var r = []
    var t = false
  ...
  function Pe(e, r, t, a) {
    ...
    while (s < e.length) {
      switch ((l = e.charAt(s))) {
        case 'G':
          if (!W(e, s)) throw new Error('unrecognized character ' + l + ' in ' + e)
    ...
    for (s = n.length - 1, o = 't'; s >= 0; --s) {
      switch (n[s].t) {
        ...
        case 'H':
          ...
          break
        case 's':
          if ((b = n[s].v.match(/\.0+$/))) g = Math.max(g, b[0].length - 1)
          if (v < 3) v = 3
        case 'd':
        case 'y':
        case 'M':
    ...
    for (s = 0; s < n.length; ++s) {
      switch (n[s].t) {
        ...
        case 'b':
        case 'Z':
          n[s].v = oe(n[s].t.charCodeAt(0), n[s].v, c, g)
          n[s].t = 't'
          break
        case 'n':
        case '?':
          ...
          while (
            ...
            ((l = n[y].t) === '?' ||
              ...
              ((l === ' ' || l === 't') &&
                n[y + 1] != null &&
                (n[y + 1].t === '?' || (n[y + 1].t === 't' && n[y + 1].v === '/'))) ||
              (n[s].t === '(' && (l === ' ' || l === 'n' || l === ')')) ||
              (l === 't' &&
                (n[y].v === '/' || (n[y].v === ' ' && n[y + 1] != null && n[y + 1].t == '?'))))
          ) {
            n[s].v += n[y].v
            n[y] = { v: '', t: ';' }
            ++y
    ...
    if (w.length > 0) {
      ...
      var _ = n.length
      if (C === n.length && S.indexOf('E') === -1) {
        for (s = n.length - 1; s >= 0; --s) {
          if (n[s] == null || 'n?'.indexOf(n[s].t) === -1) continue
          if (y >= n[s].v.length - 1) {
            y -= n[s].v.length
            n[s].v = S.substr(y + 1, n[s].v.length)
          } else if (y < 0) n[s].v = ''
          else {
            n[s].v = S.substr(0, y + 1)
            y = -1
          }
          n[s].t = 't'
          _ = s
        }
        if (y >= 0 && _ < n.length) n[_].v = S.substr(0, y + 1) + n[_].v
      } else if (C !== n.length && S.indexOf('E') === -1) {
        y = S.indexOf('.') - 1
        for (s = C; s >= 0; --s) {
          if (n[s] == null || 'n?'.indexOf(n[s].t) === -1) continue
          f = n[s].v.indexOf('.') > -1 && s === C ? n[s].v.indexOf('.') - 1 : n[s].v.length - 1
          k = n[s].v.substr(f + 1)
          for (; f >= 0; --f) {
            if (y >= 0 && (n[s].v.charAt(f) === '0' || n[s].v.charAt(f) === '#'))
              k = S.charAt(y--) + k
          }
          n[s].v = k
          n[s].t = 't'
        ...
        for (s = C; s < n.length; ++s) {
          ...
          f = n[s].v.indexOf('.') > -1 && s === C ? n[s].v.indexOf('.') + 1 : 0
          k = n[s].v.substr(0, f)
          for (; f < n[s].v.length; ++f) {
            if (y < S.length) k += S.charAt(y++)
          }
          n[s].v = k
          n[s].t = 't'
          _ = s
    ...
    for (s = 0; s < n.length; ++s)
      if (n[s] != null && 'n?'.indexOf(n[s].t) > -1) {
        x = a > 1 && r < 0 && s > 0 && n[s - 1].v === '-' ? -r : r
        n[s].v = De(n[s].t, n[s].v, x)
        n[s].t = 't'
      }
    var A = ''
  ...
  function Le(e, r) {
    ...
    if (t[0].match(/\[[=<>]/) != null || t[1].match(/\[[=<>]/) != null) {
      var s = t[0].match(Ie)
      var l = t[1].match(Ie)
      return Re(r, s) ? [a, t[0]] : Re(r, l) ? [a, t[1]] : [a, t[s != null && l != null ? 2 : 1]]
    }
    return [a, i]
  }
  function Be(e, r, t) {
    ...
    switch (typeof e) {
      ...
      case 'number':
        ...
        if (a == null) a = (t.table && t.table[G[e]]) || X[G[e]]
        if (a == null) a = Y[e] || 'General'
        break
    }
    if (W(a, 0)) return se(r, t)
    if (r instanceof Date) r = ee(r, t.date1904)
    var n = Le(a, r)
    if (W(n[1])) return se(r, t)
    if (r === true) r = 'TRUE'
  ...
  function ze(e) {
    for (var r = 0; r != 392; ++r) if (e[r] !== undefined) $e(e[r], r)
  }
  function Ue() {
    X = V()
  }
  ...
  function Xe(e, r, t) {
    var a = -1,
      ...
      l = -1,
      o = -1
    ;(r.match(He) || []).forEach(function (e, r) {
    ...
    function k(e, r) {
      ...
      for (; y < n; )
        a =
          ...
          t[e[y++]]
      n += 15
      while (y < n) a = (a >>> 8) ^ t[(a ^ e[y++]) & 255]
      return ~a
    }
    function x(e, r) {
      var a = r ^ -1
      for (var n = 0, i = e.length, s = 0, l = 0; n < i; ) {
        s = e.charCodeAt(n++)
        if (s < 128) {
          a = (a >>> 8) ^ t[(a ^ s) & 255]
        } else if (s < 2048) {
  ...
  var Ye = (function Ac() {
    ...
    function c(e, r) {
      ...
      s = d._R(4, 'i')
      d.l += 4
      d.chk('00100000', 'Mini Stream Cutoff Size: ')
      l = d._R(4, 'i')
      n = d._R(4, 'i')
      o = d._R(4, 'i')
      i = d._R(4, 'i')
      for (var y = -1, k = 0; k < 109; ++k) {
        y = d._R(4, 'i')
        if (y < 0) break
        c[k] = y
      }
      ...
      p(T, E, A)
      A.shift()
      var F = { FileIndex: T, FullPaths: E }
      if (r && r.raw) F.raw = { header: b, sectors: x }
      return F
    }
    function f(e) {
      if (e[e.l] == 80 && e[e.l + 1] == 75) return [0, 0]
      e.chk($, 'Header Signature: ')
      e.l += 16
      var r = e._R(2, 'u')
      return [e._R(2, 'u'), r]
    }
    ...
    function d(e, r, t) {
      ...
      var s = a
      while (t && n > 0 && s >= 0) {
        i.push(r.slice(s * L, s * L + L))
        n -= L
        s = ra(t, s * 4)
      }
      if (i.length === 0) return ua(0)
      return F(i).slice(0, e.size)
    }
    function m(e, r, t, a, n) {
      ...
      if (e === B) {
        ...
        if (!s) return
        for (var o = 0; o < l; ++o) {
          if ((i = ra(s, o * 4)) === B) break
          n.push(i)
        }
        m(ra(s, a - 4), r - 1, t, a, n)
      }
    }
    ...
    function g(e, r, t, a) {
      ...
      for (f = 0; f < n; ++f) {
        ...
        for (u = h; u >= 0; ) {
          ...
          p = (u * 4) & c
          if (a < 4 + p) throw new Error('FAT boundary crossed: ' + u + ' 4 ' + a)
          if (!e[m]) break
          u = ra(e[m], p)
          if (d[u]) break
        }
        i[h] = { nodes: l, data: Dt([o]) }
      }
      return i
    }
    function _(e, r, t, a, n, i, s, l) {
      var o = 0,
        c = a.length ? 2 : 0
      var f = r[e].data
      var u = 0,
      ...
      for (; u < f.length; u += 128) {
        ...
        if (b !== 0) g.ct = A(m, m.l - 8)
        var w = m._R(2) + m._R(2) + m._R(2) + m._R(2)
        if (w !== 0) g.mt = A(m, m.l - 8)
        g.start = m._R(4, 'i')
        g.size = m._R(4, 'i')
        ...
        if (g.type === 5) {
          o = g.start
          if (n > 0 && o !== B) r[o].name = '!StreamData'
        } else if (g.size >= 4096) {
          g.storage = 'fat'
          ...
          else if (o !== B && g.start !== B && r[o]) {
            g.content = d(g, r[o].data, (r[l] || {}).data)
          }
        }
        if (g.content) ca(g.content, 0)
        i[p] = g
        s.push(g)
      }
    }
    function A(e, r) {
      return new Date(((ea(e, r + 4) / 1e7) * Math.pow(2, 32) + ea(e, r) / 1e7 - 11644473600) * 1e3)
    }
    function T(e, r) {
      o()
    ...
    function E(e, r) {
      var t = r && r.type
      if (!t) {
        if (y && Buffer.isBuffer(e)) t = 'buffer'
      }
      switch (t || 'base64') {
        case 'file':
          return T(e, r)
    ...
    function P(e, n) {
      ...
      for (l = 0; l < h.length; ++l) {
        ...
        if (!s) {
          h.push([
            p,
            { name: a(p).replace('/', ''), type: 1, clsid: U, ct: c, mt: c, content: null },
          ])
          u[p] = true
        }
      }
      ...
      for (l = 0; l < h.length; ++l) {
        ...
        if (l === 0) {
          ...
          if (t(e.FullPaths[l + 1] || '') == t(m)) d.R = l + 1
          d.type = 2
        }
      }
    }
    function I(e, r) {
      var t = r || {}
      if (t.fileType == 'mad') return Ue(e, t)
      P(e)
      switch (t.fileType) {
        case 'zip':
          return Ne(e, t)
      ...
      for (i = 0; i < a[4] << 2; ++i) {
        ...
        f = e.FileIndex[i]
        if (i === 0) f.start = f.size ? f.start - 1 : B
      ...
      for (i = 1; i < e.FileIndex.length; ++i) {
        ...
        if (f.size >= 4096) {
          n.l = (f.start + 1) << 9
          if (y && Buffer.isBuffer(f.content)) {
    ...
    function R(e, r) {
      ...
      for (s = 0; s < t.length; ++s) {
        if ((l ? t[s].replace(M, '!') : t[s]).replace(O, '') == i) return e.FileIndex[s]
        if ((l ? a[s].replace(M, '!') : a[s]).replace(O, '') == i) return e.FileIndex[s]
      }
      return null
    }
    var L = 64
    var B = -2
    var $ = 'd0cf11e0a1b11ae1'
    ...
    function V(e, r) {
      ...
      switch ((r && r.type) || 'buffer') {
        ...
        case 'base64':
          return b(typeof t == 'string' ? t : H(t))
        case 'buffer':
          if (y) return Buffer.isBuffer(t) ? t : k(t)
        case 'array':
          return typeof t == 'string' ? C(t) : t
      }
      return t
    }
    var X
    ...
    function J(e) {
      return X ? X.deflateRawSync(e) : ke(e)
    }
    ...
    function Te(e, r) {
      ...
      var p = 0
      c[0] = 0
      for (h = 1; h <= o; ++h) f[h] = p = (p + c[h - 1]) << 1
      for (h = 0; h < u; ++h) if ((p = s[h]) != 0) l[h] = f[p]++
      var d = 0
      for (h = 0; h < u; ++h) {
        d = s[h]
        if (d != 0) {
          p = re[l[h]] >> (8 - d)
          for (var m = (1 << (7 - d)) - 1; m >= 0; --m) Ce[p | (m << d)] = (d & 7) | (h << 3)
        }
      }
      var v = []
      o = 1
    ...
    function Me(e, r, t, a, n) {
      ...
      var d = e._R(2)
      var m = ''
      for (var v = 0; v < p; ++v) m += String.fromCharCode(e[e.l++])
      if (d) {
        var g = s(e.slice(e.l, e.l + d))
    ...
    function Ne(e, r) {
      ...
      for (f = 1; f < e.FullPaths.length; ++f) {
        m = e.FullPaths[f].slice(d.length)
        v = e.FileIndex[f]
        if (!v.size || !v.content || m == 'Sh33tJ5') continue
        var w = h
        var y = ua(m.length)
        for (u = 0; u < m.length; ++u) y._W(1, m.charCodeAt(u) & 127)
        y = y.slice(0, y.l)
        g[p] = Ge.buf(v.content, 0)
        var k = v.content
        if (l == 8) k = J(k)
        s = ua(30)
        s._W(4, 67324752)
    ...
    function $e(e, r, t) {
      ...
      var f = je(e, a.slice(t.length), s, { unsafe: true })
      if (i) f.ctype = i
    }
    function ze(e, r) {
      if (H(e.slice(0, 13)).toLowerCase() != 'mime-version:')
        throw new Error('Unsupported MAD header')
      var t = (r && r.root) || ''
      var a = (y && Buffer.isBuffer(e) ? e.toString('binary') : H(e)).split('\r\n')
      var n = 0,
        i = ''
  ...
  function Ze(e, r, t) {
    ...
    if (typeof Blob !== 'undefined') {
      var n = new Blob([qe(a)], { type: 'application/octet-stream' })
  ...
  function sr(e, r) {
    ...
    var a = ir.getTime() + (e.getTimezoneOffset() - ir.getTimezoneOffset()) * 6e4
  ...
  var hr = new Date('2017-02-19T19:06:09.000Z')
  var pr = isNaN(hr.getFullYear()) ? new Date('2/19/17') : hr
  ...
  function mr(e, r) {
    ...
    if (pr.getFullYear() == 1917 && !isNaN(t.getFullYear())) {
      var a = t.getFullYear()
  ...
  function gr(e) {
    ...
    var r = {}
    for (var t in e) if (Object.prototype.hasOwnProperty.call(e, t)) r[t] = gr(e[t])
    return r
  }
  function br(e, r) {
    var t = ''
  ...
  function kr(e) {
    ...
    if (s.match(/jan|feb|mar|apr|may|jun|jul|aug|sep|oct|nov|dec/)) {
      ...
      if (s.length > 3 && yr.indexOf(s) == -1) return t
  ...
  function Sr(e) {
    if (!e) return null
    if (e.content && e.type) return vr(e.content, true)
    if (e.data) return h(e.data)
    if (e.asNodeBuffer && y) return h(e.asNodeBuffer().toString('binary'))
    if (e.asBinary) return h(e.asBinary())
    if (e._data && e._data.getContent)
      return h(vr(Array.prototype.slice.call(e._data.getContent(), 0)))
    return null
  }
  function Cr(e) {
    if (!e) return null
    if (e.data) return c(e.data)
    if (e.asNodeBuffer && y) return e.asNodeBuffer()
    if (e._data && e._data.getContent) {
  ...
  function _r(e) {
    return e && e.name.slice(-4) === '.bin' ? Cr(e) : Sr(e)
  }
  function Ar(e, r) {
    var t = e.FullPaths || er(e.files)
  ...
  function Mr(e, r, t) {
    if (e.FullPaths) {
      if (typeof t == 'string') {
        ...
        return Ye.utils.cfb_add(e, r, a)
      }
      Ye.utils.cfb_add(e, r, t)
    } else e.file(r, t)
  }
  function Nr() {
    ...
    if (s)
      for (c = 0; c != s.length; ++c) {
        ...
        if (l === f.length) {
          ...
          var p = (l === 5 && f.slice(0, 5) === 'xmlns' ? 'xmlns' : '') + f.slice(l + 1)
          if (a[p] && f.slice(l - 3, l) == 'ext') continue
          a[p] = o
          if (!t) a[p.toLowerCase()] = o
        }
      }
    return a
  }
      ...
      if (i == -1)
        return n
          .replace(e, function (e, r) {
            return Vr[e] || String.fromCharCode(parseInt(r, e.indexOf('x') > -1 ? 16 : 10)) || e
          })
  ...
  function mt(e, r) {
    ...
    a.forEach(function (e) {
      var r = e.replace(pt, '').match(dt)
      if (r) n.push({ v: ot(r[2]), t: r[1] })
    })
    return n
  }
  var vt = /(^\s|\s$|\n)/
  function gt(e, r) {
    return '<' + e + (r.match(vt) ? ' xml:space="preserve"' : '') + '>' + r + '</' + e + '>'
  }
  function bt(e) {
    return er(e)
      .map(function (r) {
  ...
  function wt(e, r, t) {
    return (
      ...
      e +
      (t != null ? bt(t) : '') +
      (r != null ? (r.match(vt) ? ' xml:space="preserve"' : '') + '>' + r + '</' + e : '/') +
      '>'
    )
  }
  function yt(e, r) {
  ...
  function kt(e, r) {
    switch (typeof e) {
      case 'string':
        var t = wt('vt:lpwstr', Kr(e))
        if (r) t = t.replace(/&quot;/g, '_x0022_')
        return t
      case 'number':
        return wt((e | 0) == e ? 'vt:i4' : 'vt:r8', Kr(String(e)))
      case 'boolean':
        return wt('vt:bool', e ? 'true' : 'false')
    }
    if (e instanceof Date) return wt('vt:filetime', yt(e))
    throw new Error('Unable to serialize ' + e)
  }
  function xt(e) {
    if (y && Buffer.isBuffer(e)) return e.toString('utf8')
    if (typeof e === 'string') return e
    if (typeof Uint8Array !== 'undefined' && e instanceof Uint8Array) return ot(A(E(e)))
  ...
  var Dt = y
    ...
    : Ft
  var Ot = function (e, r, t) {
    var a = []
    for (var n = r; n < t; n += 2) a.push(String.fromCharCode(Zt(e, n)))
    return a.join('').replace(O, '')
  }
  var Mt = y
    ? function (e, r, t) {
        if (!Buffer.isBuffer(e)) return Ot(e, r, t)
        return e.toString('utf16le', r, t).replace(O, '')
      }
    : Ot
  ...
  var Pt = y
    ? function (e, r, t) {
        return Buffer.isBuffer(e) ? e.toString('hex', r, r + t) : Nt(e, r, t)
      }
    : Nt
  var It = function (e, r, t) {
    var a = []
    for (var n = r; n < t; n++) a.push(String.fromCharCode(qt(e, n)))
    return a.join('')
  }
  var Rt = y
    ? function Tc(e, r, t) {
        return Buffer.isBuffer(e) ? e.toString('utf8', r, t) : It(e, r, t)
      }
    : It
  var Lt = function (e, r) {
    var t = ea(e, r)
    return t > 0 ? Rt(e, r + 4, r + 4 + t - 1) : ''
  }
  var Bt = Lt
  var $t = function (e, r) {
    var t = ea(e, r)
  ...
  function Kt() {
    Mt = function (e, r, t) {
      return $cptable.utils.decode(1200, e.slice(r, t)).replace(O, '')
    }
    Rt = function (e, r, t) {
  ...
  function aa(e, t) {
    ...
    switch (t) {
      case 'dbcs':
        f = this.l
        if (y && Buffer.isBuffer(this)) a = this.slice(this.l, this.l + 2 * e).toString('utf16le')
        else
          for (c = 0; c < e; ++c) {
            a += String.fromCharCode(Zt(this, f))
            f += 2
          }
        e *= 2
        break
      case 'utf8':
        a = Rt(this, this.l, this.l + e)
        break
      case 'utf16le':
        e *= 2
        a = Mt(this, this.l, this.l + e)
        break
      case 'wstr':
        if (typeof $cptable !== 'undefined')
          a = $cptable.utils.decode(r, this.slice(this.l, this.l + 2 * e))
        else return aa.call(this, e, 'dbcs')
        e = 2 * e
        break
      case 'lpstr-ansi':
        a = Bt(this, this.l)
      ...
      case 'cstr':
        e = 0
        a = ''
        while ((l = qt(this, this.l + e++)) !== 0) s.push(p(l))
        a = s.join('')
        break
      case '_wstr':
        e = 0
        a = ''
        while ((l = Zt(this, this.l + e)) !== 0) {
          s.push(p(l))
          e += 2
        }
        e += 2
      ...
      case 'dbcs-cont':
        ...
        for (c = 0; c < e; ++c) {
          if (this.lens && this.lens.indexOf(f) !== -1) {
            l = qt(this, f)
            this.l = f + 1
            o = aa.call(this, e - c, l ? 'dbcs-cont' : 'sbcs-cont')
            return s.join('') + o
          }
          s.push(p(Zt(this, f)))
          f += 2
      ...
      default:
        switch (e) {
          case 1:
            ...
            return n
          case 2:
            n = (t === 'i' ? Qt : Zt)(this, this.l)
            this.l += 2
            return n
          case 4:
          case -4:
            if (t === 'i' || (this[this.l + 3] & 128) === 0) {
              n = (e > 0 ? ra : ta)(this, this.l)
              this.l += 4
              return n
            } else {
              i = ea(this, this.l)
  ...
  function la(e, r, a) {
    var n = 0,
      i = 0
    if (a === 'dbcs') {
      for (i = 0; i != r.length; ++i) sa(this, r.charCodeAt(i), this.l + 2 * i)
      n = 2 * r.length
    } else if (a === 'sbcs') {
  ...
  function ga(e, r) {
    ...
    var t = Fa(e)
    if (!e.cRel && e.cRel != null) t = _a(t)
    if (!e.rRel && e.rRel != null) t = ka(t)
    return t
  }
  function ba(e, r) {
    if (e.s.r == 0 && !e.s.rRel) {
      if (e.e.r == (r.biff >= 12 ? 1048575 : r.biff >= 8 ? 65536 : 16384) && !e.e.rRel) {
        return (e.s.cRel ? '' : '$') + Ca(e.s.c) + ':' + (e.e.cRel ? '' : '$') + Ca(e.e.c)
      }
    }
    if (e.s.c == 0 && !e.s.cRel) {
      if (e.e.c == (r.biff >= 12 ? 16383 : 255) && !e.e.cRel) {
        return (e.s.rRel ? '' : '$') + ya(e.s.r) + ':' + (e.e.rRel ? '' : '$') + ya(e.e.r)
      }
    }
    return ga(e.s, r.biff) + ':' + ga(e.e, r.biff)
  }
  function wa(e) {
    return parseInt(xa(e), 10) - 1
  }
  function ya(e) {
    return '' + (e + 1)
  }
  ...
  function Da(e) {
    var r = e.indexOf(':')
    if (r == -1) return { s: Ea(e), e: Ea(e) }
    return { s: Ea(e.slice(0, r)), e: Ea(e.slice(r + 1)) }
  }
  function Oa(e, r) {
    if (typeof r === 'undefined' || typeof r === 'number') {
      return Oa(e.s, e.e)
    }
    if (typeof e !== 'string') e = Fa(e)
    if (typeof r !== 'string') r = Fa(r)
    return e == r ? e : e + ':' + r
  }
  function Ma(e) {
  ...
  function Na(e, r) {
    ...
    if (e.z != null)
      try {
        return (e.w = Be(e.z, t ? sr(r) : r))
      } catch (a) {}
    try {
      return (e.w = Be((e.XF || {}).numFmtId || (t ? 14 : 0), t ? sr(r) : r))
    } catch (a) {
      return '' + r
    }
  }
  function Pa(e, r, t) {
    ...
    if (e.t == 'e') return ln[e.v] || e.v
    if (r == undefined) return Na(e, e.v)
    return Na(e, r)
  }
  function Ia(e, r) {
  ...
  function Ra(e, r, t) {
    ...
    if (i && a.origin != null) {
      if (typeof a.origin == 'number') s = a.origin
        ...
        var o = typeof a.origin == 'string' ? Ea(a.origin) : a.origin
        s = o.r
        l = o.c
      }
    ...
    for (var u = 0; u != r.length; ++u) {
      ...
      for (var h = 0; h != r[u].length; ++h) {
        ...
        if (
          ...
          } else if (typeof p.v === 'number') p.t = 'n'
          else if (typeof p.v === 'boolean') p.t = 'b'
          else if (p.v instanceof Date) {
            p.z = a.dateNF || X[14]
            if (a.cellDates) {
              p.t = 'd'
              p.w = Be(p.z, sr(p.v))
        ...
        if (n) {
          if (!i[d]) i[d] = []
          if (i[d][v] && i[d][v].z) p.z = i[d][v].z
          i[d][v] = p
        } else {
          var g = Fa({ c: v, r: d })
          if (i[g] && i[g].z) p.z = i[g].z
          i[g] = p
        }
      }
    }
    if (c.s.c < 1e7) i['!ref'] = Oa(c)
    return i
  }
  function La(e, r) {
    return Ra(null, e, r)
  ...
  var Qa = {
    1: { n: 'CodePage', t: Ba },
    2: { n: 'Category', t: Ka },
    3: { n: 'PresentationFormat', t: Ka },
    4: { n: 'ByteCount', t: $a },
    5: { n: 'LineCount', t: $a },
    6: { n: 'ParagraphCount', t: $a },
    7: { n: 'SlideCount', t: $a },
    8: { n: 'NoteCount', t: $a },
    9: { n: 'HiddenCount', t: $a },
    10: { n: 'MultimediaClipCount', t: $a },
    11: { n: 'ScaleCrop', t: za },
    12: { n: 'HeadingPairs', t: Ya },
    13: { n: 'TitlesOfParts', t: Ja },
    14: { n: 'Manager', t: Ka },
    15: { n: 'Company', t: Ka },
    16: { n: 'LinksUpToDate', t: za },
    17: { n: 'CharacterCount', t: $a },
    19: { n: 'SharedDoc', t: za },
    22: { n: 'HyperlinksChanged', t: za },
    23: { n: 'AppVersion', t: $a, p: 'version' },
    24: { n: 'DigSig', t: Va },
    26: { n: 'ContentType', t: Ka },
    27: { n: 'ContentStatus', t: Ka },
    28: { n: 'Language', t: Ka },
    29: { n: 'Version', t: Ka },
    255: {},
    2147483648: { n: 'Locale', t: Wa },
    2147483651: { n: 'Behavior', t: Wa },
    1919054434: {},
  }
  var en = {
    1: { n: 'CodePage', t: Ba },
    ...
    16: { n: 'CharCount', t: $a },
    17: { n: 'Thumbnail', t: Xa },
    18: { n: 'Application', t: Ka },
    19: { n: 'DocSecurity', t: $a },
    255: {},
    2147483648: { n: 'Locale', t: Wa },
    2147483651: { n: 'Behavior', t: Wa },
    1919054434: {},
  ...
  function hn(e) {
    ...
    var t = {}
    ;(e.match(zr) || []).forEach(function (e) {
      var a = jr(e)
      switch (a[0].replace(Ur, '<')) {
        case '<?xml':
          break
        case '<Types':
        ...
        case '<Default':
          ...
          break
        case '<Override':
          if (r[cn[a.ContentType]] !== undefined) r[cn[a.ContentType]].push(a.PartName)
          break
      }
    })
    if (r.xmlns !== Ct.CT) throw new Error('Unknown Namespace: ' + r.xmlns)
  ...
  function pn(e, r) {
    ...
    var a = [],
      n
    a[a.length] = Rr
    a[a.length] = wt('Types', null, { xmlns: Ct.CT, 'xmlns:xsd': Ct.xsd, 'xmlns:xsi': Ct.xsi })
    a = a.concat(
      [
        ['xml', 'application/xml'],
        ...
        return wt('Default', null, { Extension: e[0], ContentType: e[1] })
      }),
    )
    var i = function (t) {
      if (e[t] && e[t].length > 0) {
        n = e[t][0]
        a[a.length] = wt('Override', null, {
          PartName: (n[0] == '/' ? '' : '/') + n,
          ContentType: fn[t][r.bookType] || fn[t]['xlsx'],
        })
      }
    }
    var s = function (t) {
    ...
    ;['coreprops', 'extprops', 'custprops'].forEach(l)
    l('vba')
    l('comments')
    l('threadedcomments')
    l('drawings')
  ...
  function vn(e, r) {
    ...
    ;(e.match(zr) || []).forEach(function (e) {
      ...
      if (n[0] === '<Relationship') {
        ...
        var s = n.TargetMode === 'External' ? n.Target : Ir(n.Target, r)
        t[s] = i
        a[n.Id] = i
      }
    })
  ...
  function gn(e) {
    var r = [Rr, wt('Relationships', null, { xmlns: Ct.RELS })]
    er(e['!id']).forEach(function (t) {
      r[r.length] = wt('Relationship', null, e['!id'][t])
    })
    if (r.length > 2) {
  ...
  function bn(e, r, t, a, n, i) {
    ...
    n.Target = t
    if (i) n.TargetMode = i
    else if ([dn.HLINK, dn.XPATH, dn.XMISS].indexOf(n.Type) > -1) n.TargetMode = 'External'
  ...
  function Cn(e) {
    ...
    for (var t = 0; t != e.length; ++t) {
      r.push(xn(e[t][0], e[t][1]))
      r.push(Sn('', e[t][0]))
    }
    r.push(xn('', 'Document', 'pkg'))
    r.push('</rdf:RDF>')
    return r.join('')
  }
  function _n() {
  ...
  function En(e) {
    ...
    for (var t = 0; t < An.length; ++t) {
      var a = An[t],
        n = e.match(Tn[t])
      if (n != null && n.length > 0) r[a[1]] = Gr(n[1])
      if (a[2] === 'date' && r[a[1]]) r[a[1]] = mr(r[a[1]])
    }
    return r
  }
  function Fn(e, r, t, a, n) {
    if (n[e] != null || r == null || r === '') return
    n[e] = r
    r = Kr(r)
    a[a.length] = t ? wt(e, r, t) : gt(e, r)
  }
  function Dn(e, r) {
    var t = r || {}
    var a = [
        Rr,
        wt('cp:coreProperties', null, {
          'xmlns:cp': Ct.CORE_PROPS,
          'xmlns:dc': Ct.dc,
          'xmlns:dcterms': Ct.dcterms,
          'xmlns:dcmitype': Ct.dcmitype,
          'xmlns:xsi': Ct.xsi,
        }),
      ],
      n = {}
    ...
    if (e) {
      if (e.CreatedDate != null)
        Fn(
          'dcterms:created',
          typeof e.CreatedDate === 'string' ? e.CreatedDate : yt(e.CreatedDate, t.WTF),
      ...
      if (e.ModifiedDate != null)
        Fn(
          'dcterms:modified',
          typeof e.ModifiedDate === 'string' ? e.ModifiedDate : yt(e.ModifiedDate, t.WTF),
          { 'xsi:type': 'dcterms:W3CDTF' },
          a,
          n,
        )
    ...
    for (var i = 0; i != An.length; ++i) {
      ...
      else if (typeof l == 'number') l = String(l)
      if (l != null) Fn(s[0], l, null, a, n)
    }
    if (a.length > 2) {
  ...
  function Pn(e, r, t) {
    ...
    if (a.HeadingPairs && a.TitlesOfParts) Nn(a.HeadingPairs, a.TitlesOfParts, r, t)
    return r
  }
  function In(e) {
    var r = [],
    ...
    r[r.length] = Rr
    r[r.length] = wt('Properties', null, { xmlns: Ct.EXT_PROPS, 'xmlns:vt': Ct.vt })
  ...
  function Bn(e) {
    var r = [Rr, wt('Properties', null, { xmlns: Ct.CUST_PROPS, 'xmlns:vt': Ct.vt })]
    if (!e) return r.join('')
    var t = 1
    er(e).forEach(function a(n) {
      ++t
      r[r.length] = wt('property', kt(e[n], true), {
  ...
  var zn = (function () {
    ...
    function a(r, t) {
      ...
      while (n.l < m && n[n.l] != 13) {
        d = {}
        d.name = $cptable.utils.decode(h, n.slice(n.l, n.l + v)).replace(/[\u0000\r\n].*$/g, '')
        n.l += v
        d.type = String.fromCharCode(n._R(1))
        if (i != 2 && !o) d.offset = n._R(4)
        d.len = n._R(1)
        if (i == 2) d.offset = n._R(2)
        d.dec = n._R(1)
        if (d.name.length) p.push(d)
        if (i != 2) n.l += o ? 13 : 14
        switch (d.type) {
          case 'B':
            if ((!l || d.len != 8) && t.WTF) console.log('Skipping ' + d.name + ':' + d.type)
            break
          case 'G':
          case 'P':
            if (t.WTF) console.log('Skipping ' + d.name + ':' + d.type)
            break
          case '+':
          case '0':
          case '@':
      ...
      var g = 0,
        b = 0
      a[0] = []
      for (b = 0; b != p.length; ++b) a[0][b] = p[b].name
      while (c-- > 0) {
        if (n[n.l] === 42) {
          n.l += u
          continue
        ...
        for (b = 0; b != p.length; ++b) {
          var y = n.slice(n.l, n.l + p[b].len)
          n.l += p[b].len
          ca(y, 0)
          var k = $cptable.utils.decode(h, y)
          switch (p[b].type) {
            case 'C':
              if (k.trim().length) a[g][b] = k.replace(/\s+$/, '')
              break
            case 'D':
              if (k.length === 8)
                a[g][b] = new Date(+k.slice(0, 4), +k.slice(4, 6) - 1, +k.slice(6, 8))
              else a[g][b] = k
              break
            case 'F':
              a[g][b] = parseFloat(k.trim())
              break
            case '+':
            case 'I':
              a[g][b] = o ? y._R(-4, 'i') ^ 2147483648 : y._R(4, 'i')
              break
            case 'L':
            ...
            case 'M':
              ...
              a[g][b] = '##MEMO##' + (o ? parseInt(k.trim(), 10) : y._R(4))
              break
            case 'N':
              k = k.replace(/\u0000/g, '').trim()
              if (k && k != '.') a[g][b] = +k || 0
              break
            case '@':
              a[g][b] = new Date(y._R(-8, 'f') - 621356832e5)
              break
            case 'T':
              a[g][b] = new Date((y._R(4) - 2440588) * 864e5 + y._R(4))
              break
            case 'Y':
              a[g][b] = y._R(4, 'i') / 1e4 + (y._R(4, 'i') / 1e4) * Math.pow(2, 32)
              break
            case 'O':
              a[g][b] = -y._R(-8, 'f')
              break
            ...
            case 'P':
              ...
              break
            case '0':
              if (p[b].name === '_NullFlags') break
            default:
              throw new Error('DBF Unsupported data type ' + p[b].type)
          }
        }
      }
      if (i != 2)
    ...
    function o(e, a) {
      var n = a || {}
      if (+n.codepage >= 0) l(+n.codepage)
      if (n.type == 'string') throw new Error('Cannot write DBF to JS string')
      var i = pa()
      var o = tc(e, { header: 1, raw: true, cellDates: true })
      var c = o[0],
        f = o.slice(1),
        u = e['!cols'] || []
      var h = 0,
      ...
      for (h = 0; h < c.length; ++h) {
        ...
        if (typeof c[h] !== 'string')
          throw new Error('DBF Invalid column name ' + c[h] + ' |' + typeof c[h] + '|')
        if (c.indexOf(c[h]) !== h)
          for (p = 0; p < 1024; ++p)
            if (c.indexOf(c[h] + '_' + p) == -1) {
              c[h] += '_' + p
              break
            }
      }
      ...
      for (h = 0; h <= v.e.c - v.s.c; ++h) {
        ...
        for (p = 0; p < f.length; ++p) {
          if (f[p][h] != null) S.push(f[p][h])
        }
        if (S.length == 0 || c[h] == null) {
          g[h] = '?'
          continue
        }
        for (p = 0; p < S.length; ++p) {
          switch (typeof S[p]) {
            ...
            case 'boolean':
              ...
              break
            case 'object':
              k = S[p] instanceof Date ? 'D' : 'C'
              break
            default:
              k = 'C'
          }
          x = Math.max(x, String(S[p]).length)
          y = y && y != k ? 'C' : k
        }
        if (x > 250) x = 250
        k = ((u[h] || {}).DBF || {}).type
        if (k == 'C') {
          if (u[h].DBF.len > x) x = u[h].DBF.len
        }
        if (y == 'B' && k == 'N') {
          y = 'N'
          w[h] = u[h].DBF.dec
      ...
      for (h = 0; h < f.length; ++h) {
        ...
        for (p = 0; p < c.length; ++p) {
          ...
          switch (g[p]) {
            case 'L':
              E._W(1, f[h][p] == null ? 63 : f[h][p] ? 84 : 70)
              break
            case 'B':
              E._W(8, f[h][p] || 0, 'f')
              break
            case 'N':
              var F = '0'
              if (typeof f[h][p] == 'number') F = f[h][p].toFixed(w[p] || 0)
              for (d = 0; d < b[p] - F.length; ++d) E._W(1, 32)
              E._W(1, F, 'sbcs')
              break
            case 'D':
              if (!f[h][p]) E._W(8, '00000000', 'sbcs')
              else {
                E._W(4, ('0000' + f[h][p].getFullYear()).slice(-4), 'sbcs')
                E._W(2, ('00' + (f[h][p].getMonth() + 1)).slice(-2), 'sbcs')
                E._W(2, ('00' + f[h][p].getDate()).slice(-2), 'sbcs')
              }
              break
            case 'C':
              var D = String(f[h][p] != null ? f[h][p] : '').slice(0, b[p])
              E._W(1, D, 'sbcs')
              for (d = 0; d < b[p] - D.length; ++d) E._W(1, 32)
              break
          }
        }
      }
    ...
    return { to_workbook: i, to_sheet: n, from_sheet: o }
  })()
  var Un = (function () {
    var e = {
      AA: 'À',
    ...
    function n(e, r) {
      switch (r.type) {
        ...
        case 'binary':
          return i(e, r)
        case 'buffer':
          return i(y && Buffer.isBuffer(e) ? e.toString('binary') : A(e), r)
        case 'array':
          return i(vr(e), r)
      }
      throw new Error('Unrecognized type ' + r.type)
    ...
    function i(e, n) {
        ...
        if (y.length > 0)
          switch (x) {
            ...
            case 'W':
              break
            case 'P':
              if (k[1].charAt(0) == 'P') h.push(y.slice(3).replace(/;;/g, ';'))
              break
            case 'C':
              var C = false,
                _ = false,
              ...
              for (f = 1; f < k.length; ++f)
                switch (k[f].charAt(0)) {
                  case 'A':
                    break
                  case 'X':
                    o = parseInt(k[f].slice(1)) - 1
                    _ = true
                    break
                  case 'Y':
                    s = parseInt(k[f].slice(1)) - 1
                    if (!_) o = 0
                  ...
                  case 'K':
                    ...
                    if (S.charAt(0) === '"') S = S.slice(1, S.length - 1)
                      ...
                      S = wr(S)
                      if (p !== null && Ne(p)) S = fr(S)
                    } else if (!isNaN(kr(S).getDate())) {
                      S = mr(S)
                    }
                    if (
                  ...
                  case 'G':
                    break
                  case 'R':
                    E = parseInt(k[f].slice(1)) - 1
                    break
                  case 'C':
                    F = parseInt(k[f].slice(1)) - 1
                    break
                  default:
                    if (n && n.WTF) throw new Error('SYLK bad record ' + y)
                }
              if (C) {
                if (u[s][o] && u[s][o].length == 2) u[s][o][0] = S
                else u[s][o] = S
                p = null
              }
              if (A) {
                if (T) throw new Error('SYLK shared formula cannot have own formula')
                var O = E > -1 && u[E][F]
                if (!O || !O[1]) throw new Error('SYLK shared formula cannot find base')
                u[s][o][1] = bs(O[1], { r: s - E, c: o - F })
              }
              break
            case 'F':
              var M = 0
      ...
      if (m.length > 0) d['!rows'] = m
      if (v.length > 0) d['!cols'] = v
    ...
    function f(e, r) {
      r.forEach(function (r, t) {
        ...
        if (r.hidden) a += '0'
          ...
          if (typeof r.width == 'number' && !r.wpx) r.wpx = di(r.width)
          if (typeof r.wpx == 'number' && !r.wch) r.wch = mi(r.wpx)
    ...
    function e(e, t) {
      switch (t.type) {
        ...
        case 'binary':
          return r(e, t)
        case 'buffer':
          return r(y && Buffer.isBuffer(e) ? e.toString('binary') : A(e), t)
        case 'array':
          return r(vr(e), t)
      }
      ...
      for (; i !== t.length; ++i) {
        ...
        switch (+o) {
          ...
          case 0:
            ...
            else if (!isNaN(wr(c))) s[a][n] = wr(c)
            else if (!isNaN(kr(c).getDate())) s[a][n] = mr(c)
            else s[a][n] = c
            ++n
            break
          case 1:
          ...
          for (var o = n.s.c; o <= n.e.c; ++o) {
            ...
            switch (i.t) {
              ...
              case 'b':
                ...
                break
              case 's':
                r(a, 1, 0, !v || isNaN(i.v) ? i.v : '="' + i.v + '"')
                break
              case 'd':
                if (!i.w) i.w = Be(i.z || X[14], sr(mr(i.v)))
                if (v) r(a, 0, i.w, 'V')
                else r(a, 1, 0, i.w)
                break
              default:
  ...
  var jn = (function () {
    ...
    return { to_workbook: n, to_sheet: a, from_sheet: f }
  })()
  var Hn = (function () {
    function e(e, r, t, a, n) {
      ...
      else if (!isNaN(wr(e))) r[t][a] = wr(e)
      else if (!isNaN(kr(e).getDate())) r[t][a] = mr(e)
      else r[t][a] = e
    }
    function r(r, t) {
      var a = t || {}
    ...
    function i(e, r) {
      ...
      var f = 0,
        ...
        v = e.charCodeAt(0)
      e = e.replace(/\r\n/gm, '\n')
      var g = t.dateNF != null ? Ve(t.dateNF) : null
      function b() {
        var r = e.slice(f, u)
        var a = {}
        ...
        if (r.length === 0) a.t = 'z'
          ...
          a.t = 'b'
          a.v = false
        } else if (!isNaN((c = wr(r)))) {
          a.t = 'n'
          if (t.cellText !== false) a.w = r
          a.v = c
        } else if (!isNaN(kr(r).getDate()) || (g && r.match(g))) {
          a.z = t.dateNF || X[14]
          var n = 0
          if (g && r.match(g)) {
            r = Xe(r, t.dateNF, r.match(g) || [])
            n = 1
          }
          if (t.cellDates) {
            a.t = 'd'
          ...
          if (t.cellText !== false) a.w = Be(a.z, a.v instanceof Date ? sr(a.v) : a.v)
    ...
    function l(e, r) {
      var t = '',
        a = r.type == 'string' ? [0, 0, 0, 0] : Oo(e, r)
      switch (r.type) {
        case 'base64':
          t = w(e)
          break
        ...
        case 'buffer':
          ...
          else t = y && Buffer.isBuffer(e) ? e.toString('binary') : A(e)
          break
        case 'array':
          t = vr(e)
          break
      ...
      if (a[0] == 239 && a[1] == 187 && a[2] == 191) t = ot(t.slice(3))
      else if (r.type != 'string' && r.type != 'buffer' && r.codepage == 65001) t = ot(t)
      else if (r.type == 'binary' && typeof $cptable !== 'undefined' && r.codepage)
        t = $cptable.utils.decode(r.codepage, $cptable.utils.encode(28591, t))
      if (t.slice(0, 19) == 'socialcalc:version:')
        return jn.to_sheet(r.type == 'string' ? t : ot(t), r)
      return s(t, r)
    }
    function o(e, r) {
      return Ia(l(e, r), r)
    ...
    return { to_workbook: o, to_sheet: l, from_sheet: c }
  })()
  function Vn(e, r) {
    var t = r || {},
      a = !!t.WTF
    t.WTF = true
    try {
      var n = Un.to_workbook(e, t)
      t.WTF = a
      return n
    } catch (i) {
      t.WTF = a
      if (!i.message.match(/SYLK bad record ID/) && a) throw i
      return Hn.to_workbook(e, r)
    }
  }
  function Xn(e) {
    var r = {},
      ...
      for (; a != t.length; ++a) {
        ...
        switch (s[0].replace(/\w*:/g, '')) {
          ...
          case '</ext>':
            ...
            break
          default:
            if (s[0].charCodeAt(1) !== 47 && !i) throw new Error('Unrecognized rich format ' + s[0])
        }
      }
    return r
  }
  ...
  function Zn(e, r) {
    ...
    if (!e) return { t: '' }
    if (e.match(/^\s*<(?:\w+:)?t[^>]*>/)) {
      a.t = Gr(ot(e.slice(e.indexOf('>') + 1).split(/<\/(?:\w+:)?t>/)[0] || ''))
      a.r = ot(e)
      if (t) a.h = Qr(a.t)
    } else if (e.match(Kn)) {
      a.r = ot(e)
      a.t = Gr(ot((e.replace(qn, '').match(Jn) || []).join('').replace(zr, '')))
      if (t) a.h = Yn(Gn(a.r))
    }
    return a
  }
  ...
  function ni(e, r) {
    if (!r.bookSST) return ''
    var t = [Rr]
    t[t.length] = wt('sst', null, { xmlns: _t[0], count: e.Count, uniqueCount: e.Unique })
    for (var a = 0; a != e.length; ++a) {
      ...
      if (n.r) i += n.r
        ...
        i += '<t'
        if (!n.t) n.t = ''
        if (n.t.match(ai)) i += ' xml:space="preserve"'
        i += '>' + Kr(n.t) + '</t>'
      }
      i += '</si>'
      t[t.length] = i
  ...
  var fi = 6,
    ...
    pi = fi
  function di(e) {
    return Math.floor((e + Math.round(128 / pi) / 256) * pi)
  }
  function mi(e) {
    return Math.floor(((e - 5) / pi) * 100 + 0.5) / 100
  }
  function vi(e) {
    return Math.round(((e * pi + 5) / pi) * 256) / 256
  }
  function gi(e) {
    return vi(mi(di(e)))
  }
  function bi(e) {
    var r = Math.abs(e - gi(e)),
      t = pi
    if (r > 0.005)
      for (pi = hi; pi < ui; ++pi)
        if (Math.abs(e - gi(e)) <= r) {
          r = Math.abs(e - gi(e))
          t = pi
        }
    pi = t
  ...
  function _i(e, r, t, a) {
    ...
    var n = {}
    var i = false
    ;(e[0].match(zr) || []).forEach(function (e) {
      var t = jr(e)
      switch (Hr(t[0])) {
        case '<borders':
        case '<borders>':
        ...
        case '<border/>':
          n = {}
          if (t.diagonalUp) n.diagonalUp = at(t.diagonalUp)
          if (t.diagonalDown) n.diagonalDown = at(t.diagonalDown)
          r.Borders.push(n)
          break
        case '</border>':
          break
    ...
    ;(e[0].match(zr) || []).forEach(function (e) {
      ...
      switch (Hr(l[0])) {
        ...
        case '<font/>':
          ...
          break
        case '<name':
          if (l.val) i.name = ot(l.val)
          break
        case '<name/>':
        case '</name>':
          break
        case '<b':
          i.bold = l.val ? at(l.val) : 1
          break
        case '<b/>':
          i.bold = 1
          break
        case '<i':
          i.italic = l.val ? at(l.val) : 1
          break
        case '<i/>':
          i.italic = 1
          break
        ...
        case '<u/>':
          ...
          break
        case '<strike':
          i.strike = l.val ? at(l.val) : 1
          break
        case '<strike/>':
          i.strike = 1
          break
        case '<outline':
          i.outline = l.val ? at(l.val) : 1
          break
        case '<outline/>':
          i.outline = 1
          break
        case '<shadow':
          i.shadow = l.val ? at(l.val) : 1
          break
        case '<shadow/>':
          i.shadow = 1
          break
        case '<condense':
          i.condense = l.val ? at(l.val) : 1
          break
        case '<condense/>':
          i.condense = 1
          break
        case '<extend':
          i.extend = l.val ? at(l.val) : 1
          break
        case '<extend/>':
          i.extend = 1
          break
        ...
        case '</sz>':
          break
        case '<vertAlign':
          if (l.val) i.vertAlign = l.val
          break
        case '<vertAlign/>':
        case '</vertAlign>':
          break
        case '<family':
          if (l.val) i.family = parseInt(l.val, 10)
          break
        case '<family/>':
        case '</family>':
          break
        case '<scheme':
          if (l.val) i.scheme = l.val
          break
        case '<scheme/>':
        case '</scheme>':
          break
        case '<charset':
          if (l.val == '1') break
          l.codepage = n[parseInt(l.val, 10)]
          break
        case '<color':
          if (!i.color) i.color = {}
          if (l.auto) i.color.auto = at(l.auto)
          if (l.rgb) i.color.rgb = l.rgb.slice(-6)
          else if (l.indexed) {
            i.color.index = parseInt(l.indexed, 10)
            var o = sn[i.color.index]
            if (i.color.index == 81) o = sn[1]
            if (!o) o = sn[1]
            i.color.rgb = o[0].toString(16) + o[1].toString(16) + o[2].toString(16)
          } else if (l.theme) {
            i.color.theme = parseInt(l.theme, 10)
            if (l.tint) i.color.tint = parseFloat(l.tint)
            if (l.theme && t.themeElements && t.themeElements.clrScheme) {
              i.color.rgb = ci(t.themeElements.clrScheme[i.color.theme].rgb, i.color.tint || 0)
            }
          }
          break
        case '<color/>':
  ...
  function Fi(e) {
    ...
    ;[
      ...
      for (var a = t[0]; a <= t[1]; ++a)
        if (e[a] != null) r[r.length] = wt('numFmt', null, { numFmtId: a, formatCode: Kr(e[a]) })
    })
    if (r.length === 1) return ''
    r[r.length] = '</numFmts>'
    r[0] = wt('numFmts', null, { count: r.length - 2 }).replace('/>', '>')
    return r.join('')
  }
    ...
    ;(e[0].match(zr) || []).forEach(function (e) {
      ...
      switch (Hr(i[0])) {
        ...
        case '<xf/>':
          a = i
          delete a[0]
          for (s = 0; s < Di.length; ++s) if (a[Di[s]]) a[Di[s]] = parseInt(a[Di[s]], 10)
          for (s = 0; s < Oi.length; ++s) if (a[Oi[s]]) a[Oi[s]] = at(a[Oi[s]])
        ...
        case '<alignment/>':
          ...
          if (i.wrapText) l.wrapText = at(i.wrapText)
          a.alignment = l
          break
        case '</alignment>':
          break
  ...
  function Ni(e) {
    var r = []
    r[r.length] = wt('cellXfs', null)
    e.forEach(function (e) {
      r[r.length] = wt('xf', null, e)
    })
    r[r.length] = '</cellXfs>'
    if (r.length === 2) return ''
    r[0] = wt('cellXfs', null, { count: r.length - 2 }).replace('/>', '>')
    return r.join('')
  }
  var Pi = (function Bc() {
    ...
    return function i(s, l, o) {
      ...
      var f
      if ((f = s.match(e))) Ei(f, c, o)
      if ((f = s.match(a))) Ti(f, c, l, o)
      if ((f = s.match(t))) Ai(f, c, l, o)
      if ((f = s.match(n))) _i(f, c, l, o)
      if ((f = s.match(r))) Mi(f, c, o)
      return c
    }
  })()
  function Ii(e, r) {
    var t = [Rr, wt('styleSheet', null, { xmlns: _t[0], 'xmlns:vt': Ct.vt })],
      a
    if (e.SSF && (a = Fi(e.SSF)) != null) t[t.length] = a
    t[t.length] =
    ...
    if ((a = Ni(r.cellXfs))) t[t.length] = a
    t[t.length] =
  ...
  function Li(e, r, t) {
    ...
    ;(e[0].match(zr) || []).forEach(function (e) {
      ...
      switch (n[0]) {
        ...
        case '</a:folHlink>':
          if (n[0].charAt(1) === '/') {
            r.themeElements.clrScheme[Ri.indexOf(n[0])] = a
            a = {}
          } else {
  ...
  function Vi(e, r) {
    if (!e || e.length === 0) e = Xi()
    var t
    var a = {}
    if (!(t = e.match(Hi))) throw new Error('themeElements not found in theme')
    ji(t[0], a, r)
    a.raw = e
    return a
  }
  ...
  function Qi(e, r) {
    ...
    var n = [
      ...
      wt('o:shapelayout', wt('o:idmap', null, { 'v:ext': 'edit', data: e }), { 'v:ext': 'edit' }),
      wt(
        'v:shapetype',
        [
          wt('v:stroke', null, { joinstyle: 'miter' }),
          wt('v:path', null, { gradientshapeok: 't', 'o:connecttype': 'rect' }),
        ].join(''),
        { id: '_x0000_t202', 'o:spt': 202, coordsize: t.join(','), path: a },
      ),
    ]
    while (Zi < e * 1e3) Zi += 1e3
    r.forEach(function (e) {
      ...
      var a =
        t.type == 'gradient'
          ? wt('o:fill', null, { type: 'gradientUnscaled', 'v:ext': 'view' })
          : null
      var i = wt('v:fill', a, t)
      ...
      n = n.concat([
        ...
        i,
        wt('v:shadow', null, s),
        wt('v:path', null, { 'o:connecttype': 'none' }),
        '<v:textbox><div style="text-align:left"></div></v:textbox>',
        '<x:ClientData ObjectType="Note">',
        '<x:MoveWithCells/>',
        '<x:SizeWithCells/>',
        gt('x:Anchor', [r.c + 1, 0, r.r + 1, 0, r.c + 3, 20, r.r + 5, 20].join(',')),
        gt('x:AutoFill', 'False'),
        gt('x:Row', String(r.r)),
        gt('x:Column', String(r.c)),
  ...
  function es(e, r, t, a) {
    ...
    r.forEach(function (r) {
      ...
      if (!i) {
        ...
        var l = Ma(e['!ref'] || 'BDWGO1000001:A1')
      ...
      if (!i.c) i.c = []
      var c = { a: r.author, t: r.t, r: r.r, T: t }
      if (r.h) c.h = r.h
  ...
  function ts(e) {
    var r = [Rr, wt('comments', null, { xmlns: _t[0] })]
    var t = []
    r.push('<authors>')
    e.forEach(function (e) {
    ...
    e.forEach(function (e) {
      ...
      if (e[1][0] && e[1][0].T && e[1][0].ID) a = t.indexOf('tc=' + e[1][0].ID)
        ...
        e[1].forEach(function (e) {
          if (e.a) a = t.indexOf(Kr(e.a))
          n.push(e.t || '')
        })
      r.push('<comment ref="' + e[0] + '" authorId="' + a + '"><text>')
      if (n.length <= 1) r.push(gt('t', Kr(n[0] || '')))
      else {
        var i = 'Comment:\n    ' + n[0] + '\n'
  ...
  function ns(e, r, t) {
    var a = [Rr, wt('ThreadedComments', null, { xmlns: Ct.TCMNT }).replace(/[\/]>/, '>')]
    e.forEach(function (e) {
      var n = ''
      ;(e[1] || []).forEach(function (i, s) {
        ...
        a.push(wt('threadedComment', gt('text', i.t || ''), l))
      })
    })
  ...
  function ss(e) {
    var r = [
      Rr,
      wt('personList', null, { xmlns: Ct.TCMNT, 'xmlns:x': _t[0] }).replace(/[\/]>/, '>'),
    ]
  ...
  function cs(e, r) {
    r.FullPaths.forEach(function (t, a) {
      ...
      if (n.slice(-1) !== '/') Ye.utils.cfb_add(e, n, r.FileIndex[a].content)
    })
  }
  ...
  var gs = (function () {
    return function e(r, t) {
      return r.replace(vs, function (e, r, a, n, i, s) {
        var l = Sa(n) - (a ? 0 : t.c)
        var o = wa(s) - (i ? 0 : t.r)
        var c = o == 0 ? '' : !i ? '[' + o + ']' : o + 1
        var f = l == 0 ? '' : !a ? '[' + l + ']' : l + 1
  ...
  function bs(e, r) {
    return e.replace(vs, function (e, t, a, n, i, s) {
      return t + (a == '$' ? a + n : Ca(Sa(n) + r.c)) + (i == '$' ? i + s : ya(wa(s) + r.r))
    })
  }
  function ws(e, r, t) {
    var a = Da(r),
  ...
  function Ss(e) {
    var r = 'of:=' + e.replace(vs, '$1[.$2$3$4$5]').replace(/\]:\[/g, ':')
  ...
  function Fs(e, r, t) {
    var a = 0,
      n = e.length
    if (t) {
      if (Es ? t.has(r) : Object.prototype.hasOwnProperty.call(t, r)) {
        var i = Es ? t.get(r) : t[r]
        for (; a < i.length; ++a) {
          if (e[i[a]].t === r) {
            e.Count++
            return i[a]
  ...
  function Ns(e, r, t, a, n, i) {
    ...
    if ((!a || a.cellText !== false) && e.t !== 'z')
      try {
        if (X[r] == null) $e(je[r] || 'General', r)
        if (e.t === 'e') e.w = e.w || ln[e.v]
        else if (r === 0) {
          if (e.t === 'n') {
        ...
        } else if (e.t === 'd') e.w = Be(r, sr(e.v), Ts)
        else e.w = Be(r, e.v, Ts)
      } catch (s) {
        if (a.WTF) throw s
      }
  ...
  function Is(e, r) {
    var t = Ma(r)
    if (t.s.r <= t.e.r && t.s.c <= t.e.c && t.s.r >= 0 && t.s.c >= 0) e['!ref'] = Oa(t)
  }
  ...
  function Xs(e, r, t, a, n, i, s) {
    ...
    var h = c.match(js)
    if (h) Ys(h[0], l, n, t)
    else if ((h = c.match(Hs))) Js(h[0], h[1] || '', l, n, t, s, i)
    var p = (c.match(/<(?:\w*:)?dimension/) || { index: -1 }).index
    if (p > 0) {
      var d = c.slice(p, p + 50).match($s)
      if (d) Is(l, d[1])
    }
    var v = c.match(Vs)
    if (v && v[1]) ol(v[1], n)
    ...
    if (u) ul(u[1], l, r, o, i, s)
    var w = f.match(Us)
    if (w) l['!autofilter'] = il(w[0])
    var y = []
    var k = f.match(Rs)
    if (k) for (p = 0; p != k.length; ++p) y[p] = Ma(k[p].slice(k[p].indexOf('"') + 1))
    var x = f.match(Bs)
    if (x) el(l, x, a)
    var S = f.match(Ws)
    if (S) l['!margins'] = rl(jr(S[0]))
    if (!l['!ref'] && o.e.c >= o.s.c && o.e.r >= o.s.r) l['!ref'] = Oa(o)
    ...
    if (y.length > 0) l['!merges'] = y
    return l
  }
  function Gs(e) {
    if (e.length === 0) return ''
    var r = '<mergeCells count="' + e.length + '">'
    for (var t = 0; t != e.length; ++t) r += '<mergeCell ref="' + Oa(e[t]) + '"/>'
    return r + '</mergeCells>'
  }
  function Ys(e, r, t, a) {
    var n = jr(e)
    if (!t.Sheets[a]) t.Sheets[a] = {}
    if (n.codeName) t.Sheets[a].CodeName = Gr(ot(n.codeName))
  }
  function Js(e, r, t, a, n) {
    Ys(e.slice(0, e.indexOf('>')), t, a, n)
  }
  function Ks(e, r, t, a, n) {
    var i = false
    var s = {},
      l = null
    ...
    if (e && e['!outline']) {
      ...
      l = (l || '') + wt('outlinePr', null, f)
    }
    if (!i && !l) return
    n[n.length] = wt('sheetPr', l, s)
  }
  ...
  function Qs(e) {
    ...
    if (e.password)
      r.password = crypto_CreatePasswordVerifier_Method1(e.password).toString(16).toUpperCase()
    return wt('sheetProtection', null, r)
  }
  function el(e, r, t) {
    var a = Array.isArray(e)
    for (var n = 0; n != r.length; ++n) {
      var i = jr(ot(r[n]), true)
      if (!i.ref) return
      var s = ((t || {})['!id'] || [])[i.id]
      if (s) {
        i.Target = s.Target
        if (i.location) i.Target += '#' + Gr(i.location)
      } else {
        i.Target = '#' + Gr(i.location)
      ...
      for (var o = l.s.r; o <= l.e.r; ++o)
        for (var c = l.s.c; c <= l.e.c; ++c) {
          ...
          if (a) {
            if (!e[o]) e[o] = []
            if (!e[o][c]) e[o][c] = { t: 'z', v: undefined }
            e[o][c].l = i
          } else {
            if (!e[f]) e[f] = { t: 'z', v: undefined }
            e[f].l = i
          }
        }
    }
  ...
  function tl(e) {
    Os(e)
    return wt('pageMargins', null, e)
  }
  function al(e, r) {
    var t = false
    for (var a = 0; a != r.length; ++a) {
      var n = jr(r[a], true)
      if (n.hidden) n.hidden = at(n.hidden)
  ...
  function sl(e, r, t, a) {
    var n = typeof e.ref == 'string' ? e.ref : Oa(e.ref)
    ...
    return wt('autoFilter', null, { ref: n })
  }
  var ll = /<(?:\w:)?sheetView(?:[^>a-z][^>]*)?\/?>/
  function ol(e, r) {
    if (!r.Views) r.Views = [{}]
    ;(e.match(ll) || []).forEach(function (e, t) {
      var a = jr(e)
      if (!r.Views[t]) r.Views[t] = {}
      if (+a.zoomScale) r.Views[t].zoom = +a.zoomScale
      if (at(a.rightToLeft)) r.Views[t].RTL = true
    })
  }
  function cl(e, r, t, a) {
    ...
    return wt('sheetViews', wt('sheetView', null, n), {})
  }
  function fl(e, r, t, a) {
    ...
    switch (e.t) {
      ...
      default:
        ...
        if (a && a.bookSST) {
          l = gt('v', '' + Fs(a.Strings, e.v, a.revStrings))
          o.t = 's'
          break
        }
        o.t = 'str'
    ...
    if (typeof e.f == 'string' && e.f) {
      var f = e.F && e.F.slice(0, r.length) == r ? { t: 'array', ref: e.F } : null
      l = wt('f', Kr(e.f), f) + (e.v != null ? l : '')
    }
  ...
  var ul = (function () {
    ...
    return function l(o, c, f, u, h, p) {
      ...
      var I = [],
        ...
        L = false
      var B = !!f.sheetStubs
      for (var $ = o.split(r), z = 0, U = $.length; z != U; ++z) {
        m = $[z].trim()
        var W = m.length
        if (W === 0) continue
        var j = 0
        e: for (d = 0; d < W; ++d)
          switch (m[d]) {
            case '>':
              ...
              if (f && f.cellStyles) {
                S = jr(m.slice(j, d), true)
                C = S.r != null ? parseInt(S.r, 10) : C + 1
                _ = -1
                if (f.sheetRows && f.sheetRows < C) continue
                R = {}
                L = false
                if (S.ht) {
                  L = true
                  R.hpt = parseFloat(S.ht)
                  R.hpx = Si(R.hpt)
                }
                if (S.hidden == '1') {
                  L = true
        ...
        v = m.slice(d).split(e)
        for (var H = 0; H != v.length; ++H) if (v[H].trim().charAt(0) != '<') break
        v = v.slice(H)
        for (d = 0; d != v.length; ++d) {
          ...
          if (g != null && g.length === 2) {
            ...
            for (w = 0; w != k.length; ++w) {
              if ((y = k.charCodeAt(w) - 64) < 1 || y > 26) break
              b = 26 * b + y
            }
            --b
            _ = b
          } else ++_
          for (w = 0; w != m.length; ++w) if (m.charCodeAt(w) === 62) break
          ++w
          S = jr(m.slice(0, w), true)
          if (!S.r) S.r = Fa({ r: C - 1, c: _ })
          k = m.slice(w)
          x = { t: '' }
          if ((g = k.match(i)) != null && g[1] !== '') x.v = Gr(g[1])
          if (f.cellFormula) {
            if ((g = k.match(s)) != null && g[1] !== '') {
              x.f = Gr(ot(g[1])).replace(/\r\n/g, '\n')
              if (!f.xlfn) x.f = ks(x.f)
              if (g[0].indexOf('t="array"') > -1) {
                x.F = (k.match(n) || [])[1]
                if (x.F.indexOf(':') > -1) M.push([Ma(x.F), x.F])
              } else if (g[0].indexOf('t="shared"') > -1) {
                T = jr(g[0])
                var V = Gr(ot(g[1]))
                if (!f.xlfn) V = ks(V)
                N[parseInt(T.si, 10)] = [T, V, S.r]
              }
            } else if ((g = k.match(/<f[^>]*\/>/))) {
              T = jr(g[0])
              if (N[T.si]) x.f = ws(N[T.si][1], N[T.si][2], S.r)
            }
            var G = Ea(S.r)
            for (w = 0; w < M.length; ++w)
              if (G.r >= M[w][0].s.r && G.r <= M[w][0].e.r)
                if (G.c >= M[w][0].s.c && G.c <= M[w][0].e.c) x.F = M[w][1]
          }
          ...
          if (D && S.s !== undefined) {
            O = p.CellXf[S.s]
            if (O != null) {
              if (O.numFmtId != null) E = O.numFmtId
              if (f.cellStyles) {
                if (O.fillId != null) F = O.fillId
              }
            }
          }
          Ns(x, E, F, f, h, p)
          if (f.cellDates && D && x.t == 'n' && Ne(X[E])) {
            x.t = 'd'
            x.v = fr(x.v)
          }
          if (S.cm && f.xlmeta) {
            var Y = (f.xlmeta.Cell || [])[+S.cm - 1]
            if (Y && Y.type == 'XLDAPR') x.D = true
          }
          if (P) {
            var J = Ea(S.r)
            if (!c[J.r]) c[J.r] = []
  ...
  function hl(e, r, t, a) {
    ...
    var m = { r: c },
      v,
      g = -1
    for (h = s.s.c; h <= s.e.c; ++h) f[h] = Ca(h)
    for (u = s.s.r; u <= s.e.r; ++u) {
      ...
      for (h = s.s.c; h <= s.e.c; ++h) {
        ...
        if ((l = fl(b, o, e, r, t, a)) != null) i.push(l)
      }
      if (i.length > 0 || (p && p[u])) {
        m = { r: c }
        if (p && p[u]) {
  ...
  function pl(e, r, t, a) {
    var n = [Rr, wt('worksheet', null, { xmlns: _t[0], 'xmlns:r': Ct.r })]
    ...
    var u = []
    Ks(o, t, e, r, n)
    n[n.length] = wt('dimension', null, { ref: c })
    n[n.length] = cl(o, r, e, t)
    if (r.sheetFormat)
      n[n.length] = wt('sheetFormatPr', null, {
    ...
    if (o['!cols'] != null && o['!cols'].length > 0) n[n.length] = nl(o, o['!cols'])
    ...
    if (o['!protect']) n[n.length] = Qs(o['!protect'])
    if (o['!autofilter'] != null) n[n.length] = sl(o['!autofilter'], o, t, e)
    if (o['!merges'] != null && o['!merges'].length > 0) n[n.length] = Gs(o['!merges'])
    var h = -1,
      p,
      d = -1
    if (o['!links'].length > 0) {
      ...
      o['!links'].forEach(function (e) {
        ...
        if (e[1].Target.charAt(0) != '#') {
          d = bn(a, -1, Kr(e[1].Target).replace(/#.*$/, ''), dn.HLINK)
          p['r:id'] = 'rId' + d
        }
        if ((h = e[1].Target.indexOf('#')) > -1) p.location = Kr(e[1].Target.slice(h + 1))
        if (e[1].Tooltip) p.tooltip = Kr(e[1].Tooltip)
        n[n.length] = wt('hyperlink', null, p)
      })
      n[n.length] = '</hyperlinks>'
    }
    delete o['!links']
    if (o['!margins'] != null) n[n.length] = tl(o['!margins'])
    if (!r || r.ignoreEC || r.ignoreEC == void 0)
      n[n.length] = gt(
        'ignoredErrors',
        wt('ignoredError', null, { numberStoredAsText: 1, sqref: c }),
      )
    if (u.length > 0) {
      d = bn(a, -1, '../drawings/drawing' + (e + 1) + '.xml', dn.DRAW)
      n[n.length] = wt('drawing', null, { 'r:id': 'rId' + d })
      o['!drawing'] = u
    }
    if (o['!comments'].length > 0) {
      d = bn(a, -1, '../drawings/vmlDrawing' + (e + 1) + '.vml', dn.VML)
      n[n.length] = wt('legacyDrawing', null, { 'r:id': 'rId' + d })
      o['!legacy'] = d
    }
    if (n.length > 1) {
  ...
  function dl(e) {
    ...
    var n = Gr((e.match(/<c:formatCode>([\s\S]*?)<\/c:formatCode>/) || ['', 'General'])[1])
  ...
  function gl(e, r, t, a) {
    var n = [Rr, wt('chartsheet', null, { xmlns: _t[0], 'xmlns:r': Ct.r })]
    n[n.length] = wt('drawing', null, { 'r:id': 'rId1' })
    bn(a, -1, '../drawings/drawing' + (e + 1) + '.xml', dn.DRAW)
    if (n.length > 2) {
    ...
    for (var t = 0; t != e.length; ++t) {
      ...
      for (var n = 0; n != r.length; ++n) {
        ...
        if (a[i[0]] == null) a[i[0]] = i[1]
          ...
          switch (i[2]) {
            case 'bool':
              if (typeof a[i[0]] == 'string') a[i[0]] = at(a[i[0]])
              break
            case 'int':
  ...
  function Sl(e, r) {
    for (var t = 0; t != r.length; ++t) {
      ...
      if (e[a[0]] == null) e[a[0]] = a[1]
        ...
        switch (a[2]) {
          case 'bool':
            if (typeof e[a[0]] == 'string') e[a[0]] = at(e[a[0]])
            break
          case 'int':
  ...
  function Cl(e) {
    ...
    xl(e.WBView, wl)
    xl(e.Sheets, yl)
    Ts.date1904 = at(e.WBProps.date1904)
  }
  function _l(e) {
    if (!e.Workbook) return 'false'
    if (!e.Workbook.WBProps) return 'false'
    return at(e.Workbook.WBProps.date1904) ? 'true' : 'false'
  }
  var Al = '][*?/\\'.split('')
  function Tl(e, r) {
    if (e.length > 31) {
  ...
  function Fl(e) {
    ...
    El(e.SheetNames, r, !!e.vbaraw)
    for (var t = 0; t < e.SheetNames.length; ++t) Ps(e.Sheets[e.SheetNames[t]], e.SheetNames[t], t)
  }
  var Dl = /<\w+:workbook/
  function Ol(e, r) {
    ...
    var i = {},
      s = 0
    e.replace(zr, function l(o, c) {
      var f = jr(o)
      switch (Hr(f[0])) {
        case '<?xml':
          break
        case '<workbook':
          if (o.match(Dl)) n = 'xmlns' + o.match(/<(\w+):/)[1]
          t.xmlns = f[n]
          break
        case '</workbook>':
          break
        ...
        case '<workbookPr/>':
          ...
          if (f.codeName) t.WBProps.CodeName = ot(f.codeName)
          break
        case '</workbookPr>':
          break
        ...
        case '<definedName':
          {
            ...
            if (at(f.hidden || '0')) i.Hidden = true
            s = c + o.length
          }
          break
        case '</definedName>':
          {
            i.Ref = Gr(ot(e.slice(s, c)))
            t.Names.push(i)
          }
          break
        case '<definedName/>':
    ...
    if (_t.indexOf(t.xmlns) === -1) throw new Error('Unknown Namespace: ' + t.xmlns)
    Cl(t)
    return t
  }
  function Ml(e) {
    var r = [Rr]
    r[r.length] = wt('workbook', null, { xmlns: _t[0], 'xmlns:r': Ct.r })
    ...
    r[r.length] = wt('workbookPr', null, a)
    ...
    r[r.length] = '<sheets>'
    for (i = 0; i != e.SheetNames.length; ++i) {
      var s = { name: Kr(e.SheetNames[i].slice(0, 31)) }
      s.sheetId = '' + (i + 1)
      s['r:id'] = 'rId' + (i + 1)
      if (n[i])
        switch (n[i].Hidden) {
    ...
    if (t) {
      ...
      if (e.Workbook && e.Workbook.Names)
        e.Workbook.Names.forEach(function (e) {
          ...
          if (!e.Ref) return
          r[r.length] = wt('definedName', Kr(e.Ref), t)
        })
      r[r.length] = '</definedNames>'
    }
    if (r.length > 2) {
  ...
  function Pl(e, r, t, a, n, i, s, l) {
    if (r.slice(-4) === '.bin') return parse_ws_bin(e, a, t, n, i, s, l)
    return Xs(e, a, t, n, i, s, l)
  }
  function Il(e, r, t, a, n, i, s, l) {
    if (r.slice(-4) === '.bin') return parse_cs_bin(e, a, t, n, i, s, l)
    return vl(e, a, t, n, i, s, l)
  }
  function Rl(e, r, t, a, n, i, s, l) {
    if (r.slice(-4) === '.bin') return ps(e, a, t, n, i, s, l)
    return ds(e, a, t, n, i, s, l)
  }
  function Ll(e, r, t, a, n, i, s, l) {
    if (r.slice(-4) === '.bin') return us(e, a, t, n, i, s, l)
    return hs(e, a, t, n, i, s, l)
  }
  function Bl(e, r, t, a) {
  ...
  function jl(e, r, t, a) {
    if (t.slice(-4) === '.bin') return Ki(e, r, t, a)
    return Ji(e, r, t, a)
  }
  function Hl(e, r, t) {
  ...
  function Vl(e, r, t) {
    return (r.slice(-4) === '.bin' ? write_wb_bin : Ml)(e, t)
  }
  function Xl(e, r, t, a, n) {
    return (r.slice(-4) === '.bin' ? write_ws_bin : pl)(e, t, a, n)
  }
  function Gl(e, r, t, a, n) {
    return (r.slice(-4) === '.bin' ? write_cs_bin : gl)(e, t, a, n)
  }
  function Yl(e, r, t) {
    return (r.slice(-4) === '.bin' ? write_sty_bin : Ii)(e, t)
  }
  function Jl(e, r, t) {
    return (r.slice(-4) === '.bin' ? write_sst_bin : ni)(e, t)
  }
  function Kl(e, r, t) {
    return (r.slice(-4) === '.bin' ? write_comments_bin : ts)(e, t)
  }
  function ql(e) {
    return (e.slice(-4) === '.bin' ? write_xlmeta_bin : Yi)()
  }
  function Zl(e, r) {
    var t = r || {}
    if (m != null && t.dense == null) t.dense = m
    ...
    for (s = 0; s < o.length; ++s) {
      ...
      for (l = 0; l < b.length; ++l) {
        ...
        var y = w,
          k = 0
        while (y.charAt(0) == '<' && (k = y.indexOf('>')) > -1) y = y.slice(k + 1)
        ...
        var C = jr(w.slice(0, w.indexOf('>')))
        h = C.colspan ? +C.colspan : 1
        if ((u = +C.rowspan) > 1 || h > 1)
          d.push({ s: { r: c, c: f }, e: { r: c + (u || 1) - 1, c: f + h - 1 } })
        var _ = C.t || C['data-t'] || ''
        if (!y.length) {
          f += h
          continue
        ...
        var A = { t: 's', v: y }
        if (t.raw || !y.trim().length || _ == 's') {
        } else if (y === 'TRUE') A = { t: 'b', v: true }
        else if (y === 'FALSE') A = { t: 'b', v: false }
        else if (!isNaN(wr(y))) A = { t: 'n', v: wr(y) }
        else if (!isNaN(kr(y).getDate())) {
          A = { t: 'd', v: mr(y) }
          if (!t.cellDates) A = { t: 'n', v: sr(A.v) }
          A.z = t.dateNF || X[14]
        }
        if (t.dense) {
          if (!a[c]) a[c] = []
  ...
  function Ql(e, r, t, a) {
    ...
    for (var s = r.s.c; s <= r.e.c; ++s) {
      ...
      var h = (u && u.v != null && (u.h || Qr(u.w || (Pa(u), u.w) || ''))) || ''
      var p = {}
      if (l > 1) p.rowspan = l
      if (o > 1) p.colspan = o
      if (a.editable) h = '<span contenteditable="true">' + h + '</span>'
        ...
        p['data-t'] = (u && u.t) || 'z'
        if (u.v != null) p['data-v'] = u.v
        if (u.z != null) p['data-z'] = u.z
  ...
  function to(e, r) {
    ...
    if (t.length == 1) return Ia(Zl(t[0], r), r)
    var a = hc()
    t.forEach(function (e, t) {
      pc(a, Zl(e, r), 'Sheet' + (t + 1))
    })
    return a
  }
  function ao(e, r, t) {
  ...
  function no(e, r) {
    var t = r || {}
    var a = t.header != null ? t.header : eo
    var n = t.footer != null ? t.footer : ro
    var i = [a]
    var s = Da(e['!ref'])
    t.dense = Array.isArray(e)
    i.push(ao(e, s, t))
    for (var l = s.s.r; l <= s.e.r; ++l) i.push(Ql(e, s, l, t))
    i.push('</table>' + n)
    return i.join('')
  }
  function io(e, r, t) {
    ...
    if (a.origin != null) {
      if (typeof a.origin == 'number') n = a.origin
        ...
        var s = typeof a.origin == 'string' ? Ea(a.origin) : a.origin
        n = s.r
        i = s.c
      }
    }
    ...
    for (; d < l.length && v < o; ++d) {
      ...
      for (g = b = 0; g < x.length; ++g) {
        var S = x[g]
        if (a.display && oo(S)) continue
        var C = S.hasAttribute('data-v')
        ...
        if ((w = +S.getAttribute('rowspan') || 1) > 1 || y > 1)
          u.push({
            s: { r: v + n, c: b + i },
            e: { r: v + n + (w || 1) - 1, c: b + i + (y || 1) - 1 },
          })
        var T = { t: 's', v: C }
        var E = S.getAttribute('data-t') || S.getAttribute('t') || ''
        if (C != null) {
          if (C.length == 0) T.t = E || 'z'
          else if (a.raw || C.trim().length == 0 || E == 's') {
          } else if (C === 'TRUE') T = { t: 'b', v: true }
          else if (C === 'FALSE') T = { t: 'b', v: false }
          else if (!isNaN(wr(C))) T = { t: 'n', v: wr(C) }
          else if (!isNaN(kr(C).getDate())) {
            T = { t: 'd', v: mr(C) }
            if (!a.cellDates) T = { t: 'n', v: sr(T.v) }
            T.z = a.dateNF || X[14]
          }
        }
        ...
        if (D && D.length)
          for (var O = 0; O < D.length; ++O)
            if (D[O].hasAttribute('href')) {
              F = D[O].getAttribute('href')
              if (F.charAt(0) != '#') break
            }
        if (F && F.charAt(0) != '#') T.l = { Target: F }
        if (a.dense) {
          if (!e[v + n]) e[v + n] = []
          e[v + n][b + i] = T
        } else e[Fa({ c: b + i, r: v + n })] = T
    ...
    c.e.r = Math.max(c.e.r, v - 1 + n)
    e['!ref'] = Oa(c)
    if (v >= o) e['!fullref'] = Oa(((c.e.r = l.length - d + v - 1 + n), c))
    return e
  }
  function so(e, r) {
    var t = r || {}
  ...
  function ho(e, r) {
    ...
    while ((v = St.exec(a)))
      switch ((v[3] = v[3].replace(/_.*$/, ''))) {
        ...
        case '工作表':
          if (v[1] === '/') {
            if (_.e.c >= _.s.c && _.e.r >= _.s.r) d['!ref'] = Oa(_)
            else d['!ref'] = 'A1:A1'
            ...
            if (E.length) d['!merges'] = E
            if (M.length) d['!rows'] = M
            f.name = f['名称'] || f.name
            if (typeof JSON !== 'undefined') JSON.stringify(f)
            p.push(f.name)
            h[f.name] = d
            H = false
        ...
        case '行':
          ...
          N = +u['number-rows-repeated'] || 1
          if (N < 10) for (V = 0; V < N; ++V) if (A > 0) M[S + V] = { level: A }
          C = -1
          break
        ...
        case '数据':
          if (v[0].charAt(v[0].length - 2) === '/') {
            ++C
            b = jr(v[0], false)
            P = parseInt(b['number-columns-repeated'] || '1', 10)
            g = { t: 'z', v: null }
            if (b.formula && t.cellFormula != false) g.f = xs(Gr(b.formula))
            if ((b['数据类型'] || b['value-type']) == 'string') {
              g.t = 's'
              g.v = Gr(b['string-value'] || '')
              if (t.dense) {
                if (!d[S]) d[S] = []
                d[S][C] = g
              } else {
            ...
            $ = []
            z = {}
            g = { t: b['数据类型'] || b['value-type'], v: null }
            if (t.cellFormula) {
              if (b.formula) b.formula = Gr(b.formula)
              if (b['number-matrix-columns-spanned'] && b['number-matrix-rows-spanned']) {
                D = parseInt(b['number-matrix-rows-spanned'], 10) || 0
                O = parseInt(b['number-matrix-columns-spanned'], 10) || 0
                F = { s: { r: S, c: C }, e: { r: S + D - 1, c: C + O - 1 } }
                g.F = Oa(F)
                I.push([F, g.F])
              }
              if (b.formula) g.f = xs(b.formula)
              else
                for (V = 0; V < I.length; ++V)
                  if (S >= I[V][0].s.r && S <= I[V][0].e.r)
                    if (C >= I[V][0].s.c && C <= I[V][0].e.c) g.F = I[V][1]
            }
            if (b['number-columns-spanned'] || b['number-rows-spanned']) {
              D = parseInt(b['number-rows-spanned'], 10) || 0
              O = parseInt(b['number-columns-spanned'], 10) || 0
              F = { s: { r: S, c: C }, e: { r: S + D - 1, c: C + O - 1 } }
              E.push(F)
            }
            if (b['number-columns-repeated']) P = parseInt(b['number-columns-repeated'], 10)
            switch (g.t) {
              case 'boolean':
                g.t = 'b'
                g.v = at(b['boolean-value'])
                break
              case 'float':
                g.t = 'n'
                g.v = parseFloat(b.value)
                break
              case 'percentage':
                g.t = 'n'
                g.v = parseFloat(b.value)
            ...
            if (w && t.cellText !== false) g.w = w
            if (j) {
              g.t = 'z'
              delete g.v
            }
            if (!j || t.sheetStubs) {
              if (!(t.sheetRows && t.sheetRows <= S)) {
                for (var G = 0; G < N; ++G) {
                  P = parseInt(b['number-columns-repeated'] || '1', 10)
                  if (t.dense) {
                    if (!d[S + G]) d[S + G] = []
                    d[S + G][C] = G == 0 ? g : gr(g)
                    while (--P > 0) d[S + G][C + P] = gr(g)
                  } else {
                    d[Fa({ r: S + G, c: C })] = g
                    while (--P > 0) d[Fa({ r: S + G, c: C + P })] = gr(g)
                  }
                  if (_.e.c <= C) _.e.c = C
                }
              }
        ...
        case 'master-styles':
          if (v[1] === '/') {
            if ((i = n.pop())[0] !== v[3]) throw 'Bad state: ' + i
          } else if (v[0].charAt(v[0].length - 2) !== '/') n.push([v[3], true])
          break
        case 'annotation':
          if (v[1] === '/') {
            if ((i = n.pop())[0] !== v[3]) throw 'Bad state: ' + i
        ...
        case 'chart':
          if (v[1] === '/') {
            if ((i = n.pop())[0] !== v[3]) throw 'Bad state: ' + i
          } else if (v[0].charAt(v[0].length - 2) !== '/') n.push([v[3], false])
          w = ''
          y = 0
          x = []
          break
        ...
        case 'text':
          ...
          else c = v.index + v[0].length
          break
        case 'named-range':
          s = jr(v[0], false)
          B = Cs(s['cell-range-address'])
          var Y = { Name: s.name, Ref: B[0] + '!' + B[1] }
          if (H) Y.Sheet = p.length
          R.Names.push(Y)
          break
        case 'text-content':
          break
        ...
        case 'database-range':
          if (v[1] === '/') break
          try {
            B = Cs(jr(v[0])['target-range-address'])
            h[B[0]]['!autofilter'] = { ref: B[1] }
          } catch (K) {}
          break
        case 'date':
          break
        ...
        case 'a':
          if (v[1] !== '/') {
            ...
            L.Target = Gr(L.href)
            delete L.href
            if (L.Target.charAt(0) == '#' && L.Target.indexOf('.') > -1) {
              B = Cs(L.Target.slice(1))
              L.Target = '#' + B[0] + '!' + B[1]
            } else if (L.Target.match(/^\.\.[\\\/]/)) L.Target = L.Target.slice(3)
          }
          break
        ...
        default:
          switch (v[2]) {
            ...
            case '字:':
              break
            default:
              if (t.WTF) throw new Error(v)
          }
      }
    var q = { Sheets: h, SheetNames: p, Workbook: R }
    if (t.bookSheets) delete q.Sheets
    return q
  }
  function po(e, r) {
    r = r || {}
    if (Ar(e, 'META-INF/manifest.xml')) yn(Er(e, 'META-INF/manifest.xml'), r)
    var t = Fr(e, 'content.xml')
    if (!t) throw new Error('Missing content.xml in ODS / UOF file')
    var a = ho(ot(t), r)
    if (Ar(e, 'meta.xml')) a.Props = En(Er(e, 'meta.xml'))
    return a
  }
  function mo(e, r) {
    return ho(e, r)
  ...
  var go = (function () {
    ...
    var a = function (a, n, i) {
      var s = []
      s.push(
        '      <table:table table:name="' + Kr(n.SheetNames[i]) + '" table:style-name="ta1">\n',
      )
      var l = 0,
        o = 0,
        c = Da(a['!ref'] || 'A1')
      ...
      var p = '',
        d = a['!rows'] || []
      for (l = 0; l < c.s.r; ++l) {
        p = d[l] ? ' table:style-name="ro' + d[l].ods + '"' : ''
        s.push('        <table:table-row' + p + '></table:table-row>\n')
      }
      for (; l <= c.e.r; ++l) {
        p = d[l] ? ' table:style-name="ro' + d[l].ods + '"' : ''
        s.push('        <table:table-row' + p + '>\n')
        ...
        for (; o <= c.e.c; ++o) {
          ...
          var b = Fa({ r: l, c: o }),
            w = h ? (a[l] || [])[o] : a[b]
          if (w && w.f) {
            v['table:formula'] = Kr(Ss(w.f))
            if (w.F) {
              if (w.F.slice(0, b.length) == b) {
                var y = Da(w.F)
                v['table:number-matrix-columns-spanned'] = y.e.c - y.s.c + 1
                v['table:number-matrix-rows-spanned'] = y.e.r - y.s.r + 1
              }
            }
          }
          if (!w) {
          ...
          switch (w.t) {
            ...
            case 'str':
              ...
              break
            case 'd':
              g = w.w || mr(w.v).toISOString()
              v['office:value-type'] = 'date'
              v['office:date-value'] = mr(w.v).toISOString()
          ...
          if (w.l && w.l.Target) {
            var x = w.l.Target
            x = x.charAt(0) == '#' ? '#' + _s(x.slice(1)) : x
            if (x.charAt(0) != '#' && !x.match(/^\w+:/)) x = '../' + x
            k = wt('text:a', k, { 'xlink:href': x.replace(/&/g, '&amp;') })
          }
          s.push('          ' + wt('table:table-cell', wt('text:p', k, {}), v) + '\n')
        }
    ...
    return function i(e, r) {
      ...
      if (r.bookType == 'fods') {
        ...
        t.push(_n().replace(/office:document-meta/g, 'office:meta'))
      } else t.push('<office:document-content' + i + '>\n')
      n(t, e)
      t.push('  <office:body>\n')
      t.push('    <office:spreadsheet>\n')
      for (var l = 0; l != e.SheetNames.length; ++l) t.push(a(e.Sheets[e.SheetNames[l]], e, l, r))
      t.push('    </office:spreadsheet>\n')
      t.push('  </office:body>\n')
  ...
  function bo(e, r) {
    if (r.bookType == 'fods') return go(e, r)
    var t = Nr()
    var a = ''
    var n = []
    var i = []
    a = 'mimetype'
    Mr(t, a, 'application/vnd.oasis.opendocument.spreadsheet')
    a = 'content.xml'
    Mr(t, a, go(e, r))
    n.push([a, 'text/xml'])
  ...
  function xo(e) {
    if (dn.WS.indexOf(e) > -1) return 'sheet'
    if (dn.CS && e == dn.CS) return 'chart'
    if (dn.DS && e == dn.DS) return 'dialog'
    if (dn.MS && e == dn.MS) return 'macro'
  ...
  function So(e, r) {
    ...
    try {
      e = r.map(function a(r) {
        ...
        return [r.name, e['!id'][r.id].Target, xo(e['!id'][r.id].Type)]
      })
    } catch (t) {
      return null
    }
  ...
  function Co(e, r, t, a, n, i, s, l, o, c, f, u) {
    try {
      i[a] = vn(Fr(e, t, true), r)
      var h = Er(e, r)
      var p
      switch (l) {
        case 'sheet':
          p = Pl(h, r, n, o, i[a], c, f, u)
          break
        case 'chart':
          p = Il(h, r, n, o, i[a], c, f, u)
          if (!p || !p['!drawel']) break
          var d = Ir(p['!drawel'].Target, r)
          var m = mn(d)
          var v = qi(Fr(e, d, true), vn(Fr(e, m, true), d))
          var g = Ir(v, d)
          var b = mn(g)
          p = ml(Fr(e, g, true), g, o, vn(Fr(e, b, true), g), c, p)
          break
        case 'macro':
          p = Rl(h, r, n, o, i[a], c, f, u)
          break
        case 'dialog':
          p = Ll(h, r, n, o, i[a], c, f, u)
          break
        default:
      ...
      var w = []
      if (i && i[a])
        er(i[a]).forEach(function (t) {
          var n = ''
          if (i[a][t].Type == dn.CMNT) {
            n = Ir(i[a][t].Target, r)
            var s = Ul(Er(e, n, true), n, o)
            if (!s || !s.length) return
            es(p, s, false)
          }
          if (i[a][t].Type == dn.TCMNT) {
            n = Ir(i[a][t].Target, r)
            w = w.concat(as(Er(e, n, true), o))
          }
        })
      if (w && w.length) es(p, w, true, o.people || [])
    } catch (y) {
      if (o.WTF) throw y
    }
  }
  ...
  function Ao(e, r) {
    ...
    r = r || {}
    yo(r)
    if (Ar(e, 'META-INF/manifest.xml')) return po(e, r)
    if (Ar(e, 'objectdata.xml')) return po(e, r)
    if (Ar(e, 'Index/Document.iwa')) {
      if (typeof Uint8Array == 'undefined')
        throw new Error('NUMBERS file parsing requires Uint8Array support')
      if (typeof parse_numbers_iwa != 'undefined') {
        if (e.FileIndex) return parse_numbers_iwa(e)
        var t = Ye.utils.cfb_new()
        Or(e).forEach(function (r) {
          Mr(t, r, Dr(e, r))
        })
        return parse_numbers_iwa(t)
      }
      throw new Error('Unsupported NUMBERS file')
    }
    if (!Ar(e, '[Content_Types].xml')) {
      if (Ar(e, 'index.xml.gz')) throw new Error('Unsupported NUMBERS 08 file')
      if (Ar(e, 'index.xml')) throw new Error('Unsupported NUMBERS 09 file')
      throw new Error('Unsupported ZIP file')
    }
    var a = Or(e)
    var n = hn(Fr(e, '[Content_Types].xml'))
    var i = false
    var s, l
    if (n.workbooks.length === 0) {
      l = 'xl/workbook.xml'
      if (Er(e, l, true)) n.workbooks.push(l)
    }
    if (n.workbooks.length === 0) {
      l = 'xl/workbook.bin'
      if (!Er(e, l, true)) throw new Error('Could not find workbook')
      n.workbooks.push(l)
      i = true
    }
    ...
    if (!r.bookSheets && !r.bookProps) {
      ...
      if (n.sst)
        try {
          As = zl(Er(e, _o(n.sst)), n.sst, r)
        } catch (f) {
          if (r.WTF) throw f
        }
      if (r.cellStyles && n.themes.length)
        o = $l(Fr(e, n.themes[0].replace(/^\//, ''), true) || '', n.themes[0], r)
      if (n.style) c = Bl(Er(e, _o(n.style)), n.style, o, r)
    }
    n.links.map(function (t) {
      try {
        var a = vn(Fr(e, mn(_o(t))), t)
        return jl(Er(e, _o(t)), a, t, r)
      } catch (n) {}
    })
    var u = Nl(Er(e, _o(n.workbooks[0])), n.workbooks[0], r)
    var h = {},
      p = ''
    if (n.coreprops.length) {
      p = Er(e, _o(n.coreprops[0]), true)
      if (p) h = En(p)
      if (n.extprops.length !== 0) {
        p = Er(e, _o(n.extprops[0]), true)
        if (p) Pn(p, h, r)
      }
    }
    var d = {}
    ...
    if (r.bookSheets || r.bookProps) {
      ...
      if (r.bookSheets && typeof s !== 'undefined') m.SheetNames = s
      if (r.bookSheets ? m.SheetNames : r.bookProps) return m
    }
    s = {}
    var v = {}
    if (r.bookDeps && n.calcchain) v = Wl(Er(e, _o(n.calcchain)), n.calcchain, r)
    var g = 0
    var b = {}
    var w, y
    {
    ...
    if (!Ar(e, _)) _ = 'xl/_rels/workbook.' + S + '.rels'
    var A = vn(Fr(e, _, true), _.replace(/_rels.*/, 's5s'))
    if ((n.metadata || []).length >= 1) {
      r.xlmeta = Hl(Er(e, _o(n.metadata[0])), n.metadata[0], r)
    }
    if ((n.people || []).length >= 1) {
      r.people = is(Er(e, _o(n.people[0])), r)
    }
    if (A) A = So(A, u.Sheets)
    var T = Er(e, 'xl/worksheets/sheet.xml', true) ? 1 : 0
    e: for (g = 0; g != h.Worksheets; ++g) {
      var E = 'sheet'
      if (A && A[g]) {
        w = 'xl/' + A[g][1].replace(/[\/]?xl\//, '')
        if (!Ar(e, w)) w = A[g][1]
        if (!Ar(e, w)) w = _.replace(/_rels\/.*$/, '') + A[g][1]
        E = A[g][2]
      } else {
        w = 'xl/worksheets/sheet' + (g + 1 - T) + '.' + S
        w = w.replace(/sheet0\./, 'sheet.')
      }
      y = w.replace(/^(.*)(\/)([^\/]*)$/, '$1/_rels/$3.rels')
      if (r && r.sheets != null)
          ...
          default:
            if (Array.isArray && Array.isArray(r.sheets)) {
              ...
              for (var D = 0; D != r.sheets.length; ++D) {
                if (typeof r.sheets[D] == 'number' && r.sheets[D] == g) F = 1
                if (
                  typeof r.sheets[D] == 'string' &&
                  r.sheets[D].toLowerCase() == h.SheetNames[g].toLowerCase()
                )
                  F = 1
              }
              if (!F) continue e
      ...
      Co(e, w, y, h.SheetNames[g], g, b, s, E, r, u, o, c)
    }
    m = {
      Directory: n,
      Workbook: u,
    ...
    if (r && r.bookVBA) {
      if (n.vba.length > 0) m.vbaraw = Er(e, _o(n.vba[0]), true)
      else if (n.defaults && n.defaults.bin === ls) m.vbaraw = Er(e, 'xl/vbaProject.bin', true)
    }
    return m
  }
  function To(e, r) {
  ...
  function Eo(e, r) {
    if (r.bookType == 'ods') return bo(e, r)
    if (r.bookType == 'numbers') return write_numbers_iwa(e, r)
    if (r.bookType == 'xlsb') return Fo(e, r)
    return Do(e, r)
  }
  function Fo(e, r) {
    Zi = 1024
    ...
    var s = '',
      l = 0
    r.cellXfs = []
    Ms(r.cellXfs, {}, { revssf: { General: 0 } })
    if (!e.Props) e.Props = {}
    s = 'docProps/core.xml'
    Mr(i, s, Dn(e.Props, r))
    n.coreprops.push(s)
    bn(r.rels, 2, s, dn.CORE_PROPS)
    s = 'docProps/app.xml'
    ...
    Mr(i, s, In(e.Props, r))
    n.extprops.push(s)
    bn(r.rels, 3, s, dn.EXT_PROPS)
    if (e.Custprops !== e.Props && er(e.Custprops || {}).length > 0) {
      s = 'docProps/custom.xml'
      Mr(i, s, Bn(e.Custprops, r))
      n.custprops.push(s)
      bn(r.rels, 4, s, dn.CUST_PROPS)
    }
    for (l = 1; l <= e.SheetNames.length; ++l) {
      ...
      switch (h) {
        ...
        default:
          ...
          Mr(i, s, Xl(l - 1, s, r, e, f))
          n.sheets.push(s)
          bn(r.wbrels, -1, 'worksheets/sheet' + l + '.' + t, dn.WS[0])
      }
      if (u) {
        var p = u['!comments']
        var d = false
        ...
        if (p && p.length > 0) {
          ...
          Mr(i, m, Kl(p, m, r))
          n.comments.push(m)
          bn(f, -1, '../comments' + l + '.' + t, dn.CMNT)
          d = true
        }
        if (u['!legacy']) {
          if (d) Mr(i, 'xl/drawings/vmlDrawing' + l + '.vml', Qi(l, u['!comments']))
        }
        delete u['!comments']
        delete u['!legacy']
      }
      if (f['!id'].rId1) Mr(i, mn(s), gn(f))
    }
    if (r.Strings != null && r.Strings.length > 0) {
      s = 'xl/sharedStrings.' + t
      Mr(i, s, Jl(r.Strings, s, r))
      n.strs.push(s)
      bn(r.wbrels, -1, 'sharedStrings.' + t, dn.SST)
    }
    s = 'xl/workbook.' + t
    Mr(i, s, Vl(e, s, r))
    n.workbooks.push(s)
    ...
    Mr(i, s, Xi(e.Themes, r))
    n.themes.push(s)
    bn(r.wbrels, -1, 'theme/theme1.xml', dn.THEME)
    s = 'xl/styles.' + t
    Mr(i, s, Yl(e, s, r))
    n.styles.push(s)
    bn(r.wbrels, -1, 'styles.' + t, dn.STY)
    if (e.vbaraw && a) {
      s = 'xl/vbaProject.bin'
      Mr(i, s, e.vbaraw)
      n.vba.push(s)
      bn(r.wbrels, -1, 'vbaProject.bin', dn.VBA)
    }
    s = 'xl/metadata.' + t
    Mr(i, s, ql(s))
    n.metadata.push(s)
    bn(r.wbrels, -1, 'metadata.' + t, dn.XLMETA)
    Mr(i, '[Content_Types].xml', pn(n, r))
    Mr(i, '_rels/.rels', gn(r.rels))
    Mr(i, 'xl/_rels/workbook.' + t + '.rels', gn(r.wbrels))
    delete r.revssf
    delete r.ssf
    return i
  }
  function Do(e, r) {
    ...
    for (l = 1; l <= e.SheetNames.length; ++l) {
      ...
      if (h) {
        ...
        if (d && d.length > 0) {
          ...
          if (g) {
            v = 'xl/threadedComments/threadedComment' + l + '.' + t
            Mr(i, v, ns(d, f, r))
            n.threadedcomments.push(v)
            bn(u, -1, '../threadedComments/threadedComment' + l + '.' + t, dn.TCMNT)
          }
          v = 'xl/comments' + l + '.' + t
          Mr(i, v, ts(d, r))
          n.comments.push(v)
          bn(u, -1, '../comments' + l + '.' + t, dn.CMNT)
          m = true
        }
        if (h['!legacy']) {
          if (m) Mr(i, 'xl/drawings/vmlDrawing' + l + '.vml', Qi(l, h['!comments']))
        }
        delete h['!comments']
        delete h['!legacy']
      }
      if (u['!id'].rId1) Mr(i, mn(s), gn(u))
    }
    if (r.Strings != null && r.Strings.length > 0) {
      s = 'xl/sharedStrings.' + t
      Mr(i, s, ni(r.Strings, r))
      n.strs.push(s)
      bn(r.wbrels, -1, 'sharedStrings.' + t, dn.SST)
    }
    s = 'xl/workbook.' + t
    ...
    if (f.length > 1) {
      ...
      Mr(i, s, ss(f, r))
      n.people.push(s)
      bn(r.wbrels, -1, 'persons/person.xml', dn.PEOPLE)
    }
    Mr(i, '[Content_Types].xml', pn(n, r))
    Mr(i, '_rels/.rels', gn(r.rels))
    Mr(i, 'xl/_rels/workbook.' + t + '.rels', gn(r.wbrels))
  ...
  function Mo(e, r) {
    if (Ye.find(e, 'EncryptedPackage')) return To(e, r)
  ...
  function No(e, r) {
    var t,
      a = e
    var n = r || {}
    if (!n.type) n.type = y && Buffer.isBuffer(e) ? 'buffer' : 'base64'
    t = Pr(a, n)
    return Ao(t, n)
  }
  function Po(e, r) {
  ...
  function Io(e, r) {
    ...
    if (a[0] == 239 && a[1] == 187 && a[2] == 191) t = ot(t)
    r.type = 'binary'
    return Po(t, r)
  }
  function Ro(e, r) {
    var t = e
    if (r.type == 'base64') t = w(t)
  ...
  function Bo(e, r, t, a) {
    if (a) {
      t.type = 'string'
      return Hn.to_workbook(e, t)
    }
    return Hn.to_workbook(r, t)
  }
  function $o(e, r) {
    o()
    var t = r || {}
    if (typeof ArrayBuffer !== 'undefined' && e instanceof ArrayBuffer)
      return $o(new Uint8Array(e), ((t = gr(t)), (t.type = 'array'), t))
    ...
    Ts = {}
    if (t.dateNF) Ts.dateNF = t.dateNF
    if (!t.type) t.type = y && Buffer.isBuffer(e) ? 'buffer' : 'base64'
    if (t.type == 'file') {
      t.type = y ? 'buffer' : 'binary'
      a = Qe(e)
      if (typeof Uint8Array !== 'undefined' && !y) t.type = 'array'
    }
    if (t.type == 'string') {
      i = true
      t.type = 'binary'
    ...
    switch ((n = Oo(a, t))[0]) {
      ...
      case 73:
        ...
        if (n[1] === 68) return Vn(a, t)
        break
      case 84:
        if (n[1] === 65 && n[2] === 66 && n[3] === 76) return Wn.to_workbook(a, t)
        break
      case 80:
        return n[1] === 75 && n[2] < 9 && n[3] < 9 ? No(a, t) : Bo(e, a, t, i)
      case 239:
        return n[3] === 60 ? parse_xlml(a, t) : Bo(e, a, t, i)
      case 255:
        if (n[1] === 254) {
          return Ro(a, t)
        } else if (n[1] === 0 && n[2] === 2 && n[3] === 0) return WK_.to_workbook(a, t)
        break
      case 0:
        if (n[1] === 0) {
          if (n[2] >= 2 && n[3] === 0) return WK_.to_workbook(a, t)
          if (n[2] === 0 && (n[3] === 8 || n[3] === 9)) return WK_.to_workbook(a, t)
        }
        break
      case 3:
      case 131:
    ...
    if ($n.indexOf(n[0]) > -1 && n[2] <= 12 && n[3] <= 31) return zn.to_workbook(a, t)
    return Bo(e, a, t, i)
  }
  function zo(e, r) {
    var t = r || {}
  ...
  function Uo(e, r) {
    switch (r.type) {
      ...
      case 'array':
        ...
        break
      case 'file':
        return Ze(r.file, Ye.write(e, { type: y ? 'buffer' : '' }))
      case 'string':
  ...
  function Ho(e, r) {
    var t = {}
    var a = y ? 'nodebuffer' : typeof Uint8Array !== 'undefined' ? 'array' : 'string'
    ...
    if (typeof Deno !== 'undefined') {
      if (typeof n == 'string') {
        ...
        n = new Uint8Array(_(n))
      }
    }
    if (r.password && typeof encrypt_agile !== 'undefined')
      return Uo(encrypt_agile(n, r.password), r)
    if (r.type === 'file') return Ze(r.file, n)
    return r.type == 'string' ? ot(n) : n
  }
  function Vo(e, r) {
    var t = r || {}
  ...
  function Yo(e, r) {
    switch (r.type) {
      ...
      case 'binary':
        ...
        return r.type == 'base64' ? b(t) : r.type == 'string' ? ot(t) : t
      case 'file':
        return Ze(r.file, e)
      case 'buffer':
        return e
  ...
  function Ko(e, r) {
    ...
    switch (t.bookType || 'xlsb') {
      case 'xml':
      case 'xlml':
        return Xo(write_xlml(e, t), t)
      case 'slk':
      case 'sylk':
        return Xo(Un.from_sheet(e.Sheets[e.SheetNames[n]], t), t)
      case 'htm':
      case 'html':
        return Xo(no(e.Sheets[e.SheetNames[n]], t), t)
      case 'txt':
        return Go(sc(e.Sheets[e.SheetNames[n]], t), t)
      case 'csv':
        return Xo(ic(e.Sheets[e.SheetNames[n]], t), t, '\ufeff')
      case 'dif':
        return Xo(Wn.from_sheet(e.Sheets[e.SheetNames[n]], t), t)
      case 'dbf':
        return Yo(zn.from_sheet(e.Sheets[e.SheetNames[n]], t), t)
      case 'prn':
        return Xo(Hn.from_sheet(e.Sheets[e.SheetNames[n]], t), t)
      case 'rtf':
        return Xo(RTF.from_sheet(e.Sheets[e.SheetNames[n]], t), t)
      case 'eth':
        return Xo(jn.from_sheet(e.Sheets[e.SheetNames[n]], t), t)
      case 'fods':
        return Xo(bo(e, t), t)
      case 'wk1':
        return Yo(WK_.sheet_to_wk1(e.Sheets[e.SheetNames[n]], t), t)
      case 'wk3':
        return Yo(WK_.book_to_wk3(e, t), t)
      case 'biff2':
        if (!t.biff) t.biff = 2
      case 'biff3':
        if (!t.biff) t.biff = 3
      case 'biff4':
        if (!t.biff) t.biff = 4
        return Yo(write_biff_buf(e, t), t)
      case 'biff5':
        if (!t.biff) t.biff = 5
      case 'biff8':
      case 'xla':
  ...
  function ec(e, r, t, a) {
    ...
    return Je.writeFile(e, Ko(r, n), i)
  }
  function rc(e, r, t, a, n, i, s, l) {
    var o = ya(t)
    var c = l.defval,
    ...
    if (!s || e[t])
      for (var d = r.s.c; d <= r.e.c; ++d) {
        ...
        if (i[d] != null) {
          if (v == null) {
            if (m.t == 'e' && v === null) h[i[d]] = null
            else if (c !== undefined) h[i[d]] = c
            else if (f && v === null) h[i[d]] = null
            else continue
          } else {
            h[i[d]] =
              f && (m.t !== 'n' || (m.t === 'n' && l.rawNumbers !== false)) ? v : Pa(m, v, l)
          }
          if (v != null) u = false
        }
      }
  ...
  function tc(e, r) {
    ...
    for (g = o.s.r + n; g <= o.e.r; ++g) {
      ...
      var x = rc(e, o, g, h, a, i, v, c)
      if (x.isempty === false || (a === 1 ? c.blankrows !== false : !!c.blankrows)) p[d++] = x.row
    }
    p.length = d
    return p
  }
  var ac = /"/g
  function nc(e, r, t, a, n, i, s, l) {
    var o = true
    var c = [],
      f = '',
      u = ya(t)
    for (var h = r.s.c; h <= r.e.c; ++h) {
      if (!a[h]) continue
      var p = l.dense ? (e[t] || [])[h] : e[a[h] + u]
      if (p == null) f = ''
      else if (p.v != null) {
        o = false
        f = '' + (l.rawNumbers && p.t == 'n' ? p.v : Pa(p, null, l))
        for (var d = 0, m = 0; d !== f.length; ++d)
          if ((m = f.charCodeAt(d)) === n || m === i || m === 34 || l.forceQuotes) {
            f = '"' + f.replace(ac, '""') + '"'
            break
          }
        if (f == 'ID') f = '"ID"'
  ...
  function ic(e, r) {
    ...
    var p = (a.skipHidden && e['!rows']) || []
    for (var d = n.s.c; d <= n.e.c; ++d) if (!(h[d] || {}).hidden) u[d] = Ca(d)
    var m = 0
    for (var v = n.s.r; v <= n.e.r; ++v) {
      if ((p[v] || {}).hidden) continue
      f = nc(e, n, v, u, s, o, i, a)
      if (f == null) {
        continue
      }
  ...
  function lc(e) {
    ...
    for (l = n.s.c; l <= n.e.c; ++l) s[l] = Ca(l)
  ...
  function oc(e, r, t) {
    ...
    var c
    var f = { s: { c: 0, r: 0 }, e: { c: l, r: s + r.length - 1 + n } }
    if (i['!ref']) {
      var u = Ma(i['!ref'])
    ...
    r.forEach(function (e, r) {
      er(e).forEach(function (t) {
        if ((p = h.indexOf(t)) == -1) h[(p = h.length)] = t
        var o = e[t]
        var f = 'z'
        var u = ''
        var d = Fa({ c: l + p, r: s + r + n })
        c = fc(i, d)
        if (o && typeof o === 'object' && !(o instanceof Date)) {
          i[d] = o
        } else {
          if (typeof o == 'number') f = 'n'
          else if (typeof o == 'boolean') f = 'b'
          else if (typeof o == 'string') f = 's'
    ...
    var d = ya(s)
    if (n) for (p = 0; p < h.length; ++p) i[Ca(p + l) + d] = { t: 's', v: h[p] }
    i['!ref'] = Oa(f)
    return i
  }
  function cc(e, r) {
  ...
  function fc(e, r, t) {
    ...
    if (typeof r != 'number') return fc(e, Fa(r))
    return fc(e, Fa({ r: r, c: t || 0 }))
  }
  function uc(e, r) {
    if (typeof r == 'number') {
  ...
  function wc(e, r, t, a) {
    var n = typeof r != 'string' ? r : Ma(r)
    var i = typeof r == 'string' ? r : Oa(r)
  ...
  var yc = {
    ...
    sheet_to_json: tc,
    sheet_to_html: no,
    sheet_to_formulae: lc,
    sheet_to_row_object_array: tc,
    sheet_get_cell: fc,
    book_new: hc,
    book_append_sheet: pc,
    book_set_sheet_visibility: dc,
    cell_set_number_format: mc,
    cell_set_hyperlink: vc,
    cell_set_internal_link: gc,
    cell_add_comment: bc,
    sheet_set_array_formula: wc,
