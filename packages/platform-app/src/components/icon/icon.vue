...
const PATH: Record<string, string> = {
  ...
  'location-pin':
    'M12 2a7 7 0 017 7c0 5-7 13-7 13S5 14 5 9a7 7 0 017-7z M12 11a2 2 0 100-4 2 2 0 000 4z',
  ...
  wechat:
    'M9 9a3 3 0 11-6 0 3 3 0 016 0z M21 14a3 3 0 11-6 0 3 3 0 016 0z M9 12c0 4 4 7 8 7 1 0 2-.1 3-.4M15 11c0-4-4-6-8-6-3 0-5 1-6 3',
  'wechat-pay':
    'M3 12a9 9 0 1118 0 9 9 0 01-18 0z M8 12c1 2 2 3 3 3 2 0 3-2 2-3-1-1-3 0-3-2 0-1 1-2 2-2',
  ...
  'home-shop':
    'M3 9l1-5h16l1 5 M3 9v11h18V9 M3 9c0 2 2 3 3 3s3-1 3-3c0 2 1 3 3 3s3-1 3-3 1 3 3 3 3-1 3-3 M10 20v-6h4v6',
  ...
  'cart-plus':
    'M3 5h2l3 12h11l3-9H6 M9 21a1 1 0 100-2 1 1 0 000 2z M18 21a1 1 0 100-2 1 1 0 000 2z M12 9v4 M10 11h4',
  ...
  truck:
    'M3 7h11v9H3z M14 11h5l2 3v2h-7 M7 19a2 2 0 100-4 2 2 0 000 4z M18 19a2 2 0 100-4 2 2 0 000 4z',
  ...
  apple:
    'M12 7c-2 0-3 1-4 2-2 2-2 6 0 8 1 1 3 2 4 2s2-1 3-1 2 1 3 1c1 0 3-1 4-3 1-2 1-5-1-7-1-1-3-2-4-2-1 0-2 1-3 1 M14 4c-1 1-2 2-3 2 0-1 1-3 3-3z',
  'apple-pay':
    'M12 7c-2 0-3 1-4 2-2 2-2 6 0 8 1 1 3 2 4 2s2-1 3-1 2 1 3 1c1 0 3-1 4-3 1-2 1-5-1-7-1-1-3-2-4-2-1 0-2 1-3 1',
  ...
  // 业务图标(biz-* 系列) —— 仅按 platform-app 实际引用补,与 merchant-app 字典共用同名 path,
  // 保证两端视觉一致;新增 biz-* 时请同步 merchant-app/src/components/icon/icon.vue
