...
export const VERIFIED_CONVERSION_OPERATIONS: ConversionOperation[] = [
  {
    ...
    inputExtensions: [
      ...
      'avif', 'bmp', 'ico', 'tiff', 'tga', 'ppm', 'jp2', 'jxl', 'qoi',
  ...
  },
  {
    ...
    inputExtensions: [
      ...
      'bmp', 'ico', 'tiff', 'tga', 'ppm', 'jp2', 'jxl', 'qoi',
      ...ADDITIONAL_IMAGE_INPUTS,
  ...
  },
  {
    id: 'convert:xlsx',
    label: '表格/PDF → Excel',
    inputExtensions: ['csv', 'tsv', 'xls', 'ods', 'pdf', 'et', 'ett', 'xlsm'],
    targetExtension: 'xlsx',
    kind: 'convert',
    options: [],
  },
  ...([
    ['odt', ['docx', 'doc', 'rtf', 'wps', 'wpt']],
    ['rtf', ['docx', 'doc', 'odt', 'wps', 'wpt']],
    ['xls', ['xlsx', 'ods', 'et', 'ett']],
    ['ods', ['xlsx', 'xls', 'et', 'ett']],
    ['pptx', ['ppt', 'odp', 'dpt']],
    ['odp', ['pptx', 'ppt', 'dpt']],
  ...
  },
  {
    ...
    inputExtensions: [
      ...
      ...ADDITIONAL_IMAGE_INPUTS,
      'ai', ...VERIFIED_RAW_INPUTS, ...VERIFIED_ADDITIONAL_RAW_INPUTS, ...VERIFIED_LARGE_RAW_INPUTS,
  ...
  ...IMAGE_OUTPUT_FORMATS.map((target) => ({
    ...
    inputExtensions: [
      ...
      ...(['jp2', 'jxl'].includes(target) ? VERIFIED_RAW_INPUTS : []),
      'ai',
