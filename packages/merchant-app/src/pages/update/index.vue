    ...
    <GlassSurface class="card" variant="card" effect="auto">
      ...
      <template v-else-if="context && latest">
        ...
        <view v-if="stage === 'downloading'" class="progress-panel">
          <view class="progress-head"><text>正在下载安装包</text><text>{{ progress }}%</text></view>
      ...
      <view v-else class="center-state">
        ...
        <text>{{ errorMessage }}</text>
        <wd-button class="primary compact" @click="loadContext" type="primary" size="small" block>重新检查</wd-button>
      </view>
    </GlassSurface>
...
.top-glow { position: absolute; top: -260rpx; left: -160rpx; width: 1080rpx; height: 700rpx; border-radius: 50%; background: linear-gradient(135deg, #ff7a52, #ff4d2d 58%, #df3219); }
...
.hero { position: relative; z-index: 1; display: flex; flex-direction: column; align-items: center; color: #fff; }
.rocket { width: 116rpx; height: 116rpx; display: flex; align-items: center; justify-content: center; border-radius: 34rpx; background: rgba(255,255,255,.2); border: 2rpx solid rgba(255,255,255,.38); box-shadow: 0 20rpx 50rpx rgba(140,35,12,.28); }
.eyebrow { margin-top: 24rpx; font-size: 21rpx; opacity: .76; letter-spacing: 3rpx; }
.title { margin-top: 12rpx; font-size: 42rpx; font-weight: 800; }
.subtitle { margin-top: 10rpx; font-size: 23rpx; opacity: .8; }
.card { position: relative; z-index: 2; margin-top: 42rpx; min-height: 660rpx; padding: 38rpx 34rpx 34rpx; border-radius: 30rpx; background: var(--bg-card); box-shadow: 0 20rpx 60rpx rgba(35,39,47,.12); }
.version-row { display: flex; align-items: center; justify-content: space-between; }
.version-block { flex: 1; display: flex; flex-direction: column; }.version-block.right { align-items: flex-end; }
.version-label { color: var(--text-tertiary); font-size: 21rpx; }.version-value { margin-top: 8rpx; color: #ff4d2d; font-size: 38rpx; font-weight: 800; }.version-value.old { color: var(--text-secondary); }.build { margin-top: 5rpx; color: #a2a7b0; font-size: 19rpx; }
.version-arrow { width: 70rpx; display: flex; justify-content: center; }
.meta-row { margin-top: 24rpx; display: flex; align-items: center; justify-content: center; gap: 10rpx; color: var(--text-tertiary); font-size: 21rpx; }.dot { color: var(--text-disabled); }.force-tag { margin-left: 6rpx; padding: 4rpx 10rpx; border-radius: 8rpx; background: #fff0eb; color: #ff4d2d; }
.notes { margin-top: 30rpx; padding: 28rpx; border-radius: 20rpx; background: var(--bg-page); display: flex; flex-direction: column; }.notes-title { color: #1f2329; font-size: 27rpx; font-weight: 700; }.notes-content { margin-top: 16rpx; color: var(--text-secondary); font-size: 24rpx; line-height: 1.7; white-space: pre-wrap; }
.progress-panel { margin-top: 28rpx; }.progress-head { display: flex; justify-content: space-between; color: var(--text-secondary); font-size: 23rpx; }.progress-track { height: 14rpx; margin-top: 16rpx; overflow: hidden; border-radius: 7rpx; background: #f0f1f3; }.progress-fill { height: 100%; border-radius: 7rpx; background: linear-gradient(90deg,#ff7a52,#ff4d2d); transition: width .2s; }.progress-size { display: block; margin-top: 10rpx; color: #a2a7b0; font-size: 20rpx; text-align: right; }
.notice { margin-top: 26rpx; padding: 22rpx 24rpx; display: flex; flex-direction: column; gap: 9rpx; border-radius: 16rpx; color: #646a73; font-size: 22rpx; line-height: 1.55; }.notice-title { font-size: 24rpx; font-weight: 700; }.notice.warning { background: #fff7e8; color: #8d5d11; }.notice.success { background: #e8fff5; color: #087a55; }.notice.error { background: #fff0f0; color: #a72a2a; }
...
.center-state { min-height: 590rpx; display: flex; flex-direction: column; align-items: center; justify-content: center; gap: 18rpx; color: var(--text-tertiary); font-size: 24rpx; text-align: center; }.spinner { width: 40rpx; height: 40rpx; border: 5rpx solid #ffd5cc; border-top-color: #ff4d2d; border-radius: 50%; animation: spin .8s linear infinite; }.error-title { color: #1f2329; font-size: 30rpx; font-weight: 700; }
.security { position: relative; z-index: 2; display: block; margin-top: 28rpx; color: #a2a7b0; font-size: 20rpx; text-align: center; }
