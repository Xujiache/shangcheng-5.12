...
const PATH: Record<string, string> = {
  ...
  'eye-off':
    'M2 2l20 20 M9 5a10 10 0 0113 7c-1 2-2 3-3 4 M6 6c-2 1-4 4-4 6 0 0 4 7 10 7 2 0 3-.4 5-1 M10 10a3 3 0 014 4',
  ...
  // 单身人形(简化版,与 biz-me 差异:头小一圈、肩线短,适合"单个用户/访客"语境)
  'user-line': 'M16 7a4 4 0 11-8 0 4 4 0 018 0z M4 21a8 8 0 0116 0',
  // 带店招的房子(屋顶 + 店面门洞,区别于 biz-home 的纯住宅)
  'home-shop': 'M3 11l9-8 9 8 M5 10v10h14V10 M9 14h6v6H9z',
  // 圆圈包勾(成功/已通过状态)
  'check-circle': 'M12 21a9 9 0 100-18 9 9 0 000 18z M8 12l3 3 5-6',
  // 定位针(与 location 同设计,作为别名兼容历史命名)
  'location-pin': 'M12 22s7-7 7-13a7 7 0 10-14 0c0 6 7 13 7 13z M12 11a2 2 0 100-4 2 2 0 000 4z',
  // 业务图标 — 视觉口径统一:line stroke,主体动作 + 1~2 笔细节,避免过度复杂
  'biz-home': 'M3 11l9-8 9 8v9a1 1 0 01-1 1h-5v-7H9v7H4a1 1 0 01-1-1z',
  'biz-product': 'M21 8l-9-5-9 5v8l9 5 9-5V8z M3 8l9 5 9-5 M12 13v9',
  'biz-order':
    'M6 3h12a1 1 0 011 1v17l-3-2-2 2-2-2-2 2-2-2-3 2V4a1 1 0 011-1z M9 8h6 M9 12h6 M9 16h4',
  // 柱状图 + 上升趋势线(原来纯 5 根条形过于像条形码,实际看不出"数据"含义)
  'biz-stats': 'M4 20h16 M7 20v-6 M12 20v-9 M17 20v-4 M5 11l4-4 3 3 6-6 M16 4h3v3',
  'biz-me': 'M12 12a4 4 0 100-8 4 4 0 000 8z M4 21c0-4 4-7 8-7s8 3 8 7',
  'biz-customer':
    'M9 11a4 4 0 100-8 4 4 0 000 8z M3 21c0-4 3-7 6-7s6 3 6 7 M16 14a3 3 0 100-6 3 3 0 000 6z M21 21c0-3-2-5-5-5',
  'biz-chat':
    'M3 12a8 8 0 0114-5 8 8 0 01-2 14l-3 1-4-5a8 8 0 01-5-5z M8 11h.01 M12 11h.01 M16 11h.01',
  'biz-store':
    'M4 9l2-5h12l2 5 M4 9v11h16V9 M4 9c0 1.5 1.3 2.5 2.5 2.5S9 10.5 9 9c0 1.5 1.3 2.5 2.5 2.5S14 10.5 14 9c0 1.5 1.3 2.5 2.5 2.5S19 10.5 19 9c0 1.5 1.3 2.5 2.5 2.5S24 10.5 24 9 M10 20v-6h4v6',
  'biz-staff':
    'M12 11a4 4 0 100-8 4 4 0 000 8z M4 21c0-3 3-7 8-7 1 0 2 .2 3 .5 M19 14l3 3 M19 20l3-3',
  // 喇叭+音浪,比原版"折线箭头"更直观
  'biz-marketing':
    'M3 10v4a1 1 0 001 1h3l6 5V4L7 9H4a1 1 0 00-1 1z M16 9a4 4 0 010 6 M19 6a8 8 0 010 12',
  ...
  'biz-commission':
    'M12 21a9 9 0 100-18 9 9 0 000 18z M15 8h-4a2 2 0 100 4h2a2 2 0 110 4H9 M12 7v1 M12 16v1',
