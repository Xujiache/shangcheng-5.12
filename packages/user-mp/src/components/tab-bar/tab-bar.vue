...
const TABS: TabItem[] = [
  {
    ...
    path_svg_filled:
      'M11.3 2.7a1 1 0 011.4 0l9 9a1 1 0 01-1.4 1.4L20 12.4V20a1 1 0 01-1 1h-4v-6h-4v6H6a1 1 0 01-1-1v-7.6l-1.3 1.3a1 1 0 01-1.4-1.4l9-9z',
  },
  {
    key: 'category',
    label: '分类',
    ...
    path_svg:
      'M4 5a1 1 0 011-1h4a1 1 0 011 1v4a1 1 0 01-1 1H5a1 1 0 01-1-1zm10 0a1 1 0 011-1h4a1 1 0 011 1v4a1 1 0 01-1 1h-4a1 1 0 01-1-1zM4 15a1 1 0 011-1h4a1 1 0 011 1v4a1 1 0 01-1 1H5a1 1 0 01-1-1zm10 0a1 1 0 011-1h4a1 1 0 011 1v4a1 1 0 01-1 1h-4a1 1 0 01-1-1z',
    path_svg_filled:
      'M4 4h5a1 1 0 011 1v5a1 1 0 01-1 1H4a1 1 0 01-1-1V5a1 1 0 011-1zm11 0h5a1 1 0 011 1v5a1 1 0 01-1 1h-5a1 1 0 01-1-1V5a1 1 0 011-1zM4 14h5a1 1 0 011 1v5a1 1 0 01-1 1H4a1 1 0 01-1-1v-5a1 1 0 011-1zm11 0h5a1 1 0 011 1v5a1 1 0 01-1 1h-5a1 1 0 01-1-1v-5a1 1 0 011-1z',
  },
  {
    key: 'cart',
    label: '购物车',
    ...
    path_svg:
      'M3 4h2.5l2.6 11.6a2 2 0 002 1.4h8.8a2 2 0 002-1.4L21 8H6.5M9 20a1.4 1.4 0 100-2.8 1.4 1.4 0 000 2.8zm9 0a1.4 1.4 0 100-2.8 1.4 1.4 0 000 2.8z',
    path_svg_filled:
      'M2.5 3a1 1 0 011-1h2a1 1 0 01.97.76L7 6H21a1 1 0 01.97 1.24l-2.4 9.6A2 2 0 0117.62 18H9.38a2 2 0 01-1.94-1.51L4.78 4.5H3.5a1 1 0 01-1-1zm6.5 18a2 2 0 100-4 2 2 0 000 4zm9 0a2 2 0 100-4 2 2 0 000 4z',
  },
  {
    key: 'me',
    label: '我的',
    ...
    path_svg_filled:
      'M12 12a5 5 0 100-10 5 5 0 000 10zm-7.5 9a.5.5 0 01-.5-.5c0-4.42 3.58-8 8-8s8 3.58 8 8a.5.5 0 01-.5.5z',
  },
]
...
.icon-cap {
  ...
  background: linear-gradient(135deg, rgba(255, 107, 69, 0.2), rgba(255, 77, 45, 0.08));
  opacity: 0;
...
.tab.active .tab-icon-img {
  width: 46rpx;
  height: 46rpx;
  filter: drop-shadow(0 2rpx 6rpx rgba(255, 77, 45, 0.4));
}
.tab-label {
  font-size: 20rpx;
  color: #94a3b8;
