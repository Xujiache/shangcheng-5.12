...
ALTER TABLE "LedgerOrder" ADD COLUMN IF NOT EXISTS "discount" INTEGER NOT NULL DEFAULT 0;
ALTER TABLE "LedgerOrder" ADD COLUMN IF NOT EXISTS "deposit" INTEGER NOT NULL DEFAULT 0;
