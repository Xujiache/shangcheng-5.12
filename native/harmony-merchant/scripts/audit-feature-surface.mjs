...
const contracts = [
  [
    ...
    [
      '/auth/merchant-password-login',
      '/auth/merchant-sms-login',
      '/u/merchant-apply',
      '/auth/logout',
    ],
  ],
  ...
  [
    ...
    ['/m/orders', '/m/refunds', 'parse-address', '/share', '/ship'],
  ],
  ...
  [
    'entry/src/main/ets/features/legal/LegalRepository.ets',
    ['/u/agreements?platform=merchant-harmony'],
  ],
  ...
  [
    ...
    ['packageSize(', 'storeUrl(', 'hasNewVersion('],
  ],
  [
    'entry/src/main/ets/features/update/UpdatePage.ets',
    ['latestSize', 'UpdatePolicy.packageSize(this.latestSize)', 'publishedAt'],
  ],
  [
    'entry/src/main/ets/pages/Index.ets',
    ['UpdatePolicy.packageSize(release.size)', 'release.publishedAt.slice(0, 10)'],
  ],
  ...
  [
    ...
    ['processingBatch', 'requestEpoch', 'await this.reload()'],
  ],
  [
    'entry/src/main/ets/features/order/OrderListPage.ets',
    ['requestEpoch', 'epoch !== this.requestEpoch'],
  ],
  [
  ...
  [
    ...
    ['failedSections', 'this.purchasing || this.restoring'],
  ],
  [
    'entry/src/main/ets/features/chat/ChatDetailPage.ets',
    ['criticalFailure', 'uploading', "payload.message.sender !== 'merchant'"],
  ],
]

const nativePlatformContracts = [
  [
    'entry/src/main/ets/core/theme/AdaptiveMaterialSurface.ets',
    ['ImmersiveMaterial', 'systemMaterial', 'sdkApiVersion >= 26', 'backgroundBlurStyle'],
  ],
  [
    'entry/src/main/ets/pages/Index.ets',
    [
  ...
  [
    'entry/src/main/ets/features/shell/MainShell.ets',
    [
  ...
  [
    'entry/src/main/ets/features/shell/PrimaryNavigationBar.ets',
    [
      "@StorageLink('darkMode')",
      'DesignTokens.elevatedSurface(this.darkMode)',
      'DesignTokens.border(this.darkMode)',
  ...
  [
    ...
    ['windowSizeChange', "'windowHeight'", 'updateSafeArea()'],
  ],
  [
    'entry/src/main/ets/core/realtime/CommerceEventPolicy.ets',
    ['order.new', 'order.update', 'refund.new', 'chat.message', 'auth.failed'],
  ],
  [
    'entry/src/main/ets/core/network/ApiClient.ets',
    [
      'RefreshSingleFlight',
      'RefreshFailurePolicy.clearsSession',
      'response.responseCode === 401',
      '服务端返回了无效响应',
    ],
  ],
  [
    'entry/src/main/ets/core/network/RefreshPolicy.ets',
    ['class RefreshSingleFlight', 'class RefreshFailurePolicy', 'this.task = undefined'],
  ],
  [
    'entry/src/main/ets/core/realtime/HarmonyRealtime.ets',
    [
      'RealtimePolicy.acceptsEnvelope',
      'RealtimePolicy.reconnectDelay',
      'this.reconnectAttempt = 0',
    ],
  ],
  [
    'entry/src/main/ets/core/push/PushRoutePolicy.ets',
    ['order-detail', 'after-sale-detail', 'chat-detail', '!id'],
  ],
  ['entry/src/main/ets/core/push/PushRouteService.ets', ['PushRoutePolicy.fromRaw']],
  [
    'entry/src/main/ets/core/iap/IapProductPolicy.ets',
    ['subscription', 'consumable', 'Unsupported Huawei IAP product type'],
  ],
  ['entry/src/main/ets/core/iap/HuaweiIapService.ets', ['IapProductPolicy.normalize']],
  [
    'entry/src/main/ets/features/product/ProductSkuMatrix.ets',
    ['combinationKey', 'regenerate(', 'normalize(', 'active: sku.active !== false'],
  ],
  [
    'entry/src/main/ets/features/product/ProductEditPage.ets',
    [
      'ProductSkuMatrix.regenerate',
      'ProductSkuMatrix.normalize',
  ...
  [
    'entry/src/main/ets/features/order/AfterSalePolicy.ets',
    ['approvedAmount(', 'amount > appliedAmount', 'rejectReason('],
  ],
  [
    'entry/src/main/ets/features/order/AfterSalePage.ets',
    ['AfterSalePolicy.approvedAmount', 'AfterSalePolicy.rejectReason'],
  ],
  [
    'entry/src/main/ets/features/order/AfterSaleDetailPage.ets',
    ['AfterSalePolicy.approvedAmount', 'AfterSalePolicy.rejectReason'],
  ],
  [
    'entry/src/main/ets/core/file/UploadPolicy.ets',
    ['SUPPORTED_BIZ_TYPES', 'selectionLimit(', 'shouldRefresh(', 'isSuccessful('],
  ],
  [
    'entry/src/main/ets/core/file/FileUploadService.ets',
    [
      'UploadPolicy.normalizeBizType',
      'UploadPolicy.selectionLimit',
      'UploadPolicy.shouldRefresh',
      'UploadPolicy.isSuccessful',
    ],
  ],
  [
    'entry/src/main/ets/features/profile/LocationPolicy.ets',
    ['isValidCoordinate(', 'acceptsEpoch(', 'joinRegion(', 'coordinateLabel('],
  ],
  [
    'entry/src/main/ets/features/profile/LocationPickerPage.ets',
    [
      'LocationPolicy.isValidCoordinate',
      'LocationPolicy.acceptsEpoch',
      'LocationPolicy.selectedAddress',
      "'pickedLocationSet', true",
    ],
  ],
  [
    ...
    [
      ...
      'hasLocation',
      "'pickedLocationSet'",
      'this.hasLocation ? this.latitude : undefined',
      'this.uploading || this.saving',
      '头像仍在上传',
    ],
  ],
  [
    'entry/src/ohosTest/ets/test/CoreLogic.test.ets',
    [
      'coalesces concurrent refresh work',
      'killed-process sessions',
      'missing Asset Store record',
      'manual checks always remain available',
      'whitelisted Push Kit deep links',
      'SKU cartesian products',
  ...
  [
    'entry/src/main/ets/entryability/EntryAbility.ets',
    ['TYPE_SYSTEM_GESTURE', 'TYPE_NAVIGATION_INDICATOR'],
  ],
  ...
  [
    ...
    [
      ...
      'saveTransient',
      'discardTransient',
      'Persist the refresh token first',
    ],
  ],
  [
    'entry/src/main/ets/core/storage/OfflineCacheStore.ets',
    ['relationalStore', 'SecurityLevel.S2', 'encrypt: true', 'cache_entries'],
  ],
  [
    'entry/src/main/ets/core/security/SecureStore.ets',
    [
      'asset.update(query, update)',
      'asset.add(attributes)',
      'Retrying update makes the write idempotent',
    ],
  ],
  [
    'entry/src/main/ets/features/auth/AuthRepository.ets',
    [
      'saveTransient(result)',
      'SessionRecoveryPolicy.decide',
      'SessionRecoveryDecision.DISCARD_APPLICANT',
      'discardApplicationSession()',
      'session.discardTransient()',
      'payload, false',
    ],
  ],
  [
    'entry/src/main/ets/features/auth/MerchantSessionPolicy.ets',
    [
      "role === 'factory'",
      "role === 'store'",
      "role === 'merchant'",
  ...
  [
    'entry/src/main/ets/features/auth/LoginPage.ets',
    ['MerchantSessionPolicy.canEnterWorkbench(session)'],
  ],
  [
    'entry/src/main/ets/features/auth/MerchantApplyPage.ets',
    [
      'discardTransient()',
      'discardApplicationSession()',
      'this.submitting',
      'this.sendingCode || this.countdown > 0',
    ],
  ],
  [
    'entry/src/main/ets/core/push/PushPreferenceStore.ets',
    ['jingwei_push_alert_preferences', 'orders', 'refunds', 'chat'],
  ],
  [
    'entry/src/main/ets/core/file/FileUploadService.ets',
    ['PhotoViewPicker', 'cameraPicker.pick', 'ohos.permission.CAMERA', 'captureAndUploadImage'],
  ],
  [
    'entry/src/main/ets/features/profile/LocationPickerPage.ets',
    [
  ...
  [
    ...
    ['ShareController', 'getSystemPasteboard', 'ImageSaveService'],
  ],
]
...
for (const [name, relative] of required) {
  ...
  if (
    source.trim().length < 300 ||
    !/(build\(\)|@Builder|NavDestination|Navigation)/.test(source)
  ) {
